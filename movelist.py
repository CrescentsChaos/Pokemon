...
class Moves:
    def __init__(self):
        ...
        self.soundmoves=["Boomburst","Bug Buzz","Clanging Scales","Clangorous Soul","Clangorous Soulblaze","Disarming Voice","Grass Whistle","Heal Bell","Howl","Hyper Voice","Metal Sound","Noble Roar","Overdrive","Parting Shot","Perish Song","Relic Song","Torch Song","Roar","Shadow Panic","Snarl","Snore","Sparkling Aria","Roar"]
