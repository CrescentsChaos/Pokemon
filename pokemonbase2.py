...
#                self.tera=random.choice(["Rock","Fire","Water","Grass","Electric","Ground","Flying","Fighting","Fairy","Dragon","Steel","Poison","Dark","Ghost","Normal","Bug","Ice"])
        ...
        if self.item not in megastones and "Alpha " not in name and self.totem == 7 and maxiv not in ["Yes"]:
            self.name=f"Totem {name}(Z-Crystal)"
...
class Machamp(Pokemon2):
    ...
    def __init__(self,name="Machamp",type1="Fighting",type2="None",nature="None",level=100,happiness=255,hp=90,atk=130,defense=80,spatk=65,spdef=85,speed=55,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["No Guard","Guts"]),item=random.choice(["Choice Band","Black Belt","Expert Belt","Payapa Berry","Lum Berry","Sitrus Berry","Scope Lens","White Herb","Focus Sash","Choice Scarf"]),weight=286.60):
        if move =="None":
            avmoves=["Dynamic Punch","Close Combat","Superpower","Fire Punch","Cross Chop","Submission","Darkest Lariat","Drain Punch","Mach Punch","Rock Slide","Bulldoze","Dual Chop","Bulk Up","Earthquake","Stone Edge","Ice Punch"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if ability=="Guts":
...
class Tentacruel(Pokemon2):
    ...
    def __init__(self,name="Tentacruel",type1="Water",type2="Poison",nature="None",level=100,happiness=255,hp=80,atk=60,defense=75,spatk=95,spdef=120,speed=100,hpev=0,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=252,maxiv="No",move="None", ability=random.choice(["Clear Body","Liquid Ooze","Rain Dish"]),item=random.choice(["Black Sludge","Apicot Berry","Scope Lens","Focus Sash"]),weight=121.25):
        if move =="None":
            avmoves=["Hidden Power","Ice Beam","Hydro Pump","Thunderbolt","Sludge Bomb","Poison Jab","Rain Dance","Toxic Spikes","Sludge Wave","Giga Drain","Scald","Rest"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rest" in moves:
...
class Golem(Pokemon2):
    "Golem"
    def __init__(self,name="Golem",type1="Rock",type2="Ground",nature="None",level=100,happiness=255,hp=80,atk=120,defense=130,spatk=55,spdef=65,speed=45,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Rock Head","Sturdy"]),item=random.choice(["Weakness Policy","Rindo Berry","Salac Berry","Passho Berry","Lum Berry","Ground Gem","Choice Band"])):
        if move =="None":
...
class Dodrio(Pokemon2):
    "Dodrio"
    def __init__(self,name="Dodrio",type1="Normal",type2="Flying",nature="None",level=100,happiness=255,hp=60,atk=130,defense=70,spatk=60,spdef=60,speed=110,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Rock Head","Early Bird","Quick Feet","Defiant"]),item=random.choice(["Choice Scarf","Heavy-Duty Boots","Wacan Berry"])):
        if move =="None":
...
class Garbodor(Pokemon2):
    def __init__(self,name="Garbodor",type1="Poison",type2="None",nature="None",level=100,happiness=255,hp=80,atk=105,defense=92,spatk=60,spdef=92,speed=75,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Aftermath","Stench","Unburden","Weak Armor"]),item=random.choice(["Black Sludge","Shuca Berry","Payapa Berry","Salac Berry","Expert Belt"])):
        if move =="None":
...
class Muk(Pokemon2):
    "Muk"
    def __init__(self,name="Muk",type1="Poison",type2="None",nature="None",level=100,happiness=255,hp=105,atk=110,defense=75,spatk=65,spdef=100,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Poison Touch","Regenerator","Sticky Hold","Stench"]),item=random.choice(["Black Sludge","Shuca Berry","Payapa Berry","Quick Claw"])):
        if move =="None":
...
class Cloyster(Pokemon2):
    ...
    def __init__(self,name="Cloyster",type1="Water",type2="Ice",nature="None",level=100,happiness=255,hp=50,atk=95,defense=180,spatk=85,spdef=45,speed=70,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Skill Link","Shell Armor","Overcoat"]),item=random.choice(["Focus Sash","King's Rock","Salac Berry"])):
        if move =="None":
            avmoves=["Ice Beam","Rock Blast","Icicle Spear","Shell Smash","Hydro Pump","Pin Missile","Snowscape","Liquidation","Razor Shell","Explosion"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                               
...
class Hitmontop(Pokemon2):
    def __init__(self,name="Hitmontop",type1="Fighting",type2="None",nature="None",level=100,happiness=255,hp=60,atk=100,defense=95,spatk=35,spdef=110,speed=70,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Technician"]),item=random.choice(["Choice Band","Assault Vest","Liechi Berry","Wide Lens"])):
        if move =="None":
            avmoves=["Triple Kick","Sucker Punch","Superpower","Gyro Ball","Low Kick","Close Combat","Rapid Spin","Triple Axel","Dig","Drill Run","Bulk Up","Bullet Punch","Mach Punch"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Komala(Pokemon2):
    def __init__(self,name="Komala",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=75,atk=115,defense=65,spatk=75,spdef=95,speed=65,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability="Comatose",item=random.choice(["Silk Scarf","Leftovers"])):
        if move =="None":
            avmoves=["Last Resort","Body Slam","Sucker Punch","Wood Hammer","Zen Headbutt","Outrage","Aqua Tail","Hammer Arm","Thrash"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item) 
...
class Eevee(Pokemon2):
    "Kangaskhan"
    def __init__(self,name="Eevee",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=65,atk=75,defense=70,spatk=65,spdef=85,speed=90,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability="Adaptability",item=random.choice(["Silk Scarf","Heavy-Duty Boots","Chople Berry"])):
        if move =="None":
...
class Starmie(Pokemon2):
    "Starmie"
    def __init__(self,name="Starmie",type1="Water",type2="Psychic",nature="None",level=100,happiness=255,hp=60,atk=75,defense=85,spatk=100,spdef=85,speed=115,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Natural Cure","Analytic"]),item=random.choice(["Life Orb","Sitrus Berry","Mystic Water","Ganlon Berry","Petaya Berry","Choice Scarf","Choice Specs","Focus Sash","Expert Belt","Wide Lens","Lum Berry"])):
        if move =="None":
            avmoves=["Meteor Beam","Hidden Power","Ice Beam","Scald","Psychic","Surf","Hydro Pump","Thunderbolt","Flip Turn","Recover","Rapid Spin","Minimize","Recover","Cosmic Power","Psyshock","Grass Knot","Reflect","Light Screen","Thunder","Blizzard","Rain Dance"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Tauros(Pokemon2):
    "Tauros"
    def __init__(self,name="Tauros",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=75,atk=100,defense=95,spatk=70,spdef=70,speed=110,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Sheer Force","Anger Point"]),item=random.choice(["Life Orb","Lum Berry"])):
        if move =="None":
...
class Gyarados(Pokemon2):
    ...
    def __init__(self,name="Gyarados",type1="Water",type2="Flying",nature="None",level=100,happiness=255,hp=95,atk=125,defense=79,spatk=60,spdef=100,speed=81,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Moxie"]),item=random.choice(["Mystic Water","Heavy-Duty Boots","Lum Berry","Gyaradosite","Muscle Band","Wacan Berry","Leftovers","King's Rock"])):
        if move =="None":
            avmoves=["Crunch","Waterfall","Earthquake","Aqua Tail","Ice Fang","Power Whip","Scale Shot","Stone Edge","Outrage","Substitute","Rest"]
...
class Omastar(Pokemon2):
    "Omastar"
    def __init__(self,name="Omastar",type1="Rock",type2="Water",nature="None",level=100,happiness=255,hp=70,atk=60,defense=125,spatk=115,spdef=70,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Shell Armor","Swift Swim","Weak Armor"]),item=random.choice(["White Herb","Mystic Water","Rindo Berry"])):
        if move =="None":
...
class Zapdos(Pokemon2):
    "Zapdos"
    def __init__(self,name="Zapdos",type1="Electric",type2="Flying",nature="None",level=100,happiness=255,hp=90,atk=90,defense=85,spatk=125,spdef=90,speed=100,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Lightning Rod","Static","Pressure"]),item=random.choice(["Choice Specs","Heavy-Duty Boots","Life Orb","Focus Band","Bright Powder","King's Rock","Sharp Beak"])):
        if move =="None":
            avmoves=["Protect","Hidden Power","Thunder","Brave Bird","Thunderbolt","Sky Attack","Roost","Thunder Wave","Bolt Beak","Razor Wind"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)             
...
class Mewtwo(Pokemon2):
    "Mewtwo"
    def __init__(self,name="Mewtwo",type1="Psychic",type2="None",nature="None",level=100,happiness=255,hp=106,atk=110,defense=90,spatk=154,spdef=90,speed=130,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Pressure","Unnerve"]),item=random.choice(["Expert Belt","Life Orb","Mewtwonite X","Mewtwonite Y","Berserk Gene"])):
        if move =="None":
...
class Meganium(Pokemon2):
    "Meganium"
    def __init__(self,name="Meganium",type1="Grass",type2="Fairy",nature="None",level=100,happiness=255,hp=80,atk=62,defense=110,spatk=93,spdef=110,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Triage","Overgrow","Filter"]),item=random.choice(["Leftovers"])):
        if move =="None":
...
class Feraligatr(Pokemon2):
    ...
    def __init__(self,name="Feraligatr",type1="Water",type2="Dark",nature="None",level=100,happiness=255,hp=85,atk=110,defense=100,spatk=79,spdef=83,speed=78,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sheer Force","Torrent","Strong Jaw","Intimidate"]),item=random.choice(["Choice Band","Life Orb","King's Rock","Wacan Berry"])):
        if move =="None":
            avmoves=["Protect","Ice Beam","Hydro Pump","Liquidation","Dragon Claw","Hydro Cannon","Ice Fang","Jaw Lock","Dragon Dance","Swords Dance","Scale Shot","Power-up Punch","Substitute","Razor Wind"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)        
...
class Vaporeon(Pokemon2):
    "Vaporeon"
    def __init__(self,name="Vaporeon",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=130,atk=65,defense=60,spatk=110,spdef=95,speed=65,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=252,speedev=0,maxiv="No",move="None", ability="Water Absorb",item=random.choice(["Leftovers","Heavy-Duty Boots","Rindo Berry"])):
        if move =="None":
            avmoves=["Protect","Hidden Power","Ice Beam","Hydro Pump","Acid Armor","Surf","Rain Dance","Flip Turn","Chilling Water","Calm Mind","Aqua Ring","Rain Dance"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rain Dance" in moves:
...
class Jolteon(Pokemon2):
    "Jolteon"
    def __init__(self,name="Jolteon",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=65,atk=65,defense=60,spatk=110,spdef=95,speed=130,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Volt Absorb","Quick Feet"]),item=random.choice(["Choice Specs","Heavy-Duty Boots","Air Balloon","Shuca Berry","Sitrus Berry","Razor Claw","Bright Powder"])):
        if move =="None":
...
class Flareon(Pokemon2):
    "Flareon"
    def __init__(self,name="Flareon",type1="Fire",type2="None",nature="None",level=100,happiness=255,hp=65,atk=130,defense=65,spatk=60,spdef=95,speed=110,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Flash Fire","Guts"]),item=random.choice(["Heavy-Duty Boots","Salac Berry","Quick Claw","Charcoal"])):
        if move =="None":
            avmoves=["Protect","Flare Blitz","Fire Blast","Flame Charge","Last Resort","Will-O-Wisp","Calm Mind","Sacred Fire","Gunk Shot","Flail","Yawn","Superpower","Overheat"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Lanturn(Pokemon2):
    "Lanturn"
    def __init__(self,name="Lanturn",type1="Water",type2="Electric",nature="None",level=100,happiness=255,hp=125,atk=58,defense=88,spatk=76,spdef=106,speed=67,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Volt Absorb","Water Absorb"]),item=random.choice(["Leftovers","Sitrus Berry","Wide Lens","Rindo Berry","Quick Claw"])):
        if move =="None":
...
class Ampharos(Pokemon2):
    "Amoharos"
    def __init__(self,name="Ampharos",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=90,atk=75,defense=85,spatk=115,spdef=90,speed=55,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=252,speedev=0,maxiv="No",move="None", ability="Static",item=random.choice(["Life Orb","Leftovers","Ampharosite","Sitrus Berry","Shuca Berry","Petaya Berry","Expert Belt","Zoom Lens"])):
        if move =="None":
...
class Umbreon(Pokemon2):
    "Umbreon"
    def __init__(self,name="Umbreon",type1="Dark",type2="None",nature="None",level=100,happiness=255,hp=95,atk=70,defense=110,spatk=70,spdef=130,speed=55,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move="None", ability="Inner Focus",item=random.choice(["Leftovers","Bright Powder","Scope Lens"])):
        if move =="None":
...
class Heracross(Pokemon2):
    "Heracross"
    def __init__(self,name="Heracross",type1="Bug",type2="Fighting",nature="None",level=100,happiness=255,hp=80,atk=125,defense=75,spatk=40,spdef=95,speed=85,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Guts","Moxie","Swarm"]),item=random.choice(["Coba Berry","Heracronite","Salac Berry","Choice Band","Choice Scarf","Focus Band"])):
        if move =="None":
            avmoves=["Protect","Megahorn","Brick Break","X-Scissor","U-turn","Close Combat","Superpower","Substitute","Stone Edge","Swords Dance","Aerial Ace","Shadow Claw","Focus Punch"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if ability=="Guts":
...
class Skarmory(Pokemon2):
    "Skarmory"
    def __init__(self,name="Skarmory",type1="Steel",type2="Flying",nature="None",level=100,happiness=255,hp=65,atk=80,defense=140,spatk=40,spdef=70,speed=70,hpev=252,atkev=0,defev=252,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability="Sturdy",item=random.choice(["Leftovers","Rocky Helmet","Salac Berry","Wacan Berry","Life Orb"])):
        if move =="None":
...
class Houndoom(Pokemon2):
    "Houndoom"
    def __init__(self,name="Houndoom",type1="Dark",type2="Fire",nature="None",level=100,happiness=255,hp=75,atk=95,defense=50,spatk=110,spdef=80,speed=105,hpev=0,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=252,maxiv="No",move="None", ability=random.choice(["Flash Fire","Intimidate","Unnerve"]),item=random.choice(["Life Orb","Houndoominite","Passho Berry","Petaya Berry","Focus Sash"])):
        if move =="None":
...
class Kingdra(Pokemon2):
    "Kingdra"
    def __init__(self,name="Kingdra",type1="Water",type2="Dragon",nature="None",level=100,happiness=255,hp=75,atk=85,defense=95,spatk=105,spdef=95,speed=85,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Swift Swim","Sniper"]),item=random.choice(["Life Orb","Haban Berry","Scope Lens","Lum Berry","Wide Lens"])):
        if move =="None":
...
class Raikou(Pokemon2):
    "Raikou"
    def __init__(self,name="Raikou",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=90,atk=85,defense=75,spatk=115,spdef=100,speed=115,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Inner Focus","Pressure"]),item=random.choice(["Leftovers","Heavy-Duty Boots","Air Balloon","Shuca Berry","Magnet","Lax Incense","Wise Glasses"])):
        if move =="None":
...
class Entei(Pokemon2):
    "Entei"
    def __init__(self,name="Entei",type1="Fire",type2="None",nature="None",level=100,happiness=255,hp=115,atk=115,defense=85,spatk=90,spdef=75,speed=100,hpev=0,atkev=115,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Inner Focus","Pressure"]),item=random.choice(["Choice Band","Heavy-Duty Boots","Wise Glasses","Leftovers"])):
        if move =="None":
...
class Suicune(Pokemon2):
    "Suicune"
    def __init__(self,name="Suicune",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=100,atk=75,defense=115,spatk=90,spdef=115,speed=85,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Inner Focus","Pressure"]),item=random.choice(["Leftovers","Wacan Berry","Never Melt Ice"])):
        if move =="None":
            avmoves=["Protect","Crunch","Surf","Hydro Pump","Recover","Hyper Beam","Rain Dance","Scald","Extreme Speed","Light Screen","Tailwind","Rest","Ice Beam","Blizzard","Extrasensory"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rest" in moves:
...
class Blaziken(Pokemon2):
    "Blaziken"
    def __init__(self,name="Blaziken",type1="Fire",type2="Fighting",nature="None",level=100,happiness=255,hp=80,atk=130,defense=70,spatk=100,spdef=70,speed=80,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Speed Boost","Striker","Blaze","Sheer Force"]),item=random.choice(["Life Orb","Focus Sash","Blazikenite","Salac Berry","Air Balloon","Shell Bell","Passho Berry"])):
        if move =="None":
...
class Ludicolo(Pokemon2):
    "Ludicolo"
    def __init__(self,name="Ludicolo",type1="Grass",type2="Water",nature="None",level=100,happiness=255,hp=80,atk=70,defense=90,spatk=110,spdef=100,speed=70,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Swift Swim","Dancer","Rain Dish"]),item=random.choice(["Life Orb","Leftovers","Lum Berry"])):
        if move =="None":
...
class Swellow(Pokemon2):
    "Swellow"
    def __init__(self,name="Swellow",type1="Normal",type2="Flying",nature="None",level=100,happiness=255,hp=60,atk=85,defense=70,spatk=100,spdef=65,speed=125,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Guts","Aerilate"]),item=random.choice(["Choice Specs","Heavy-Duty Boots","Flying Gem","Liechi Berry"])):
        if move =="None":
            avmoves=["Protect","Roost","Brave Bird","Facade","Hurricane","Boomburst","Double Team","Endeavor","Aerial Ace"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if ability=="Guts":
...
class Pelipper(Pokemon2):
    "Pelipper"
    def __init__(self,name="Pelipper",type1="Water",type2="Flying",nature="None",level=100,happiness=255,hp=65,atk=35,defense=100,spatk=100,spdef=80,speed=65,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability="Drizzle",item=random.choice(["Heavy-Duty Boots","Damp Rock","Petaya Berry"])):
        if move =="None":
            avmoves=["Protect","Roost","Surf","Ice Beam","Hurricane","Hydro Pump","Scald","Chilling Water","Air Slash","Weather Ball","Tailwind"]
...
class Breloom(Pokemon2):
    "Breloom"
    def __init__(self,name="Breloom",type1="Grass",type2="Fighting",nature="None",level=100,happiness=255,hp=60,atk=130,defense=80,spatk=60,spdef=60,speed=80,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability="Poison Heal",item=random.choice(["Toxic Orb","Coba Berry","Focus Sash","Shell Bell"])):
        if move =="None":
...
class Slaking(Pokemon2):
    "Slaking"
    def __init__(self,name="Slaking",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=150,atk=160,defense=100,spatk=95,spdef=65,speed=100,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability="Truant",item=random.choice(["Leftovers","Sitrus Berry","Eject Button","Choice Band"]),truant=False):
        if move =="None":
...
class Hariyama(Pokemon2):
    "Hariyama"
    def __init__(self,name="Hariyama",type1="Fighting",type2="None",nature="None",level=100,happiness=255,hp=144,atk=120,defense=80,spatk=40,spdef=80,speed=50,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Guts","Thick Fat"]),item=random.choice(["Sitrus Berry","Bright Powder","Leftovers","Salac Berry","Quick Claw"])):
        if move =="None":
...
class Aggron(Pokemon2):
    "Aggron"
    def __init__(self,name="Aggron",type1="Steel",type2="Rock",nature="None",level=100,happiness=255,hp=70,atk=110,defense=180,spatk=60,spdef=60,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Rock Head","Sturdy","Heavy Metal"]),item=random.choice(["Choice Band","Leftovers","Aggronite","Custap Berry","Chople Berry","Focus Sash","Air Balloon","Quick Claw"])):
        if move =="None":
...
class Torkoal (Pokemon2):
    "Torkoal"
    def __init__(self,name="Torkoal",type1="Fire",type2="None",nature="None",level=100,happiness=255,hp=90,atk=75,defense=140,spatk=95,spdef=80,speed=20,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Drought","White Smoke","Shell Armor"]),item=random.choice(["Leftovers","Heat Rock","Fire Gem"])):
        if move =="None":
            avmoves=["Protect","Lava Plume","Thunder Wave","Flamethrower","Toxic","Stealth Rock","Explosion","Earth Power","Yawn","Shell Smash","Heat Wave","Solar Beam","Gyro Ball"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                       
...
class Sharpedo(Pokemon2):
    "Sharpedo"
    def __init__(self,name="Sharpedo",type1="Water",type2="Dark",nature="None",level=100,happiness=255,hp=70,atk=120,defense=40,spatk=95,spdef=40,speed=95,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Speed Boost","Rough Skin"]),item=random.choice(["Life Orb","Sharpedonite","Focus Sash"])):
        if move =="None":
            avmoves=["Protect","Flip Turn","Hydro Pump","Crunch","Ice Beam","Surf","Dark Pulse","Scale Shot","Zen Headbutt","Awua Jet"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)              
...
class Wailord(Pokemon2):
    "Wailord"
    def __init__(self,name="Wailord",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=170,atk=90,defense=70,spatk=105,spdef=100,speed=30,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Blubber Defense","Oblivious","Pressure"]),item=random.choice(["Leftovers","Sitrus Berry","Choice Scarf","Wacan Berry","Quick Claw","Mystic Water"])):
        if move =="None":
            avmoves=["Protect","Water Spout","Hydro Pump","Blizzard","Ice Beam","Surf","Rain Dance","Heavy Slam","Rest","Explosion","Hydro Cannon","Aqua Ring","Avalanche","Amnesia","Bounce","Fissure"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                
...
class Camerupt(Pokemon2):
    "Camerupt"
    def __init__(self,name="Camerupt",type1="Fire",type2="Ground",nature="None",level=100,happiness=255,hp=90,atk=100,defense=70,spatk=105,spdef=75,speed=40,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Solid Rock","Anger Point","Magma Armor"]),item=random.choice(["Leftovers","Camerupite","Passho Berry","Shuca Berry"])):
        if move =="None":
...
class Arbok(Pokemon2):
    "Arbok"
    def __init__(self,name="Arbok",type1="Poison",type2="Dark",nature="None",level=100,happiness=255,hp=75,atk=105,defense=75,spatk=65,spdef=80,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Strong Jaw","Shed Skin","Unnerve"]),item=random.choice(["Black Sludge","Shuca Berry"])):
        if move =="None":
...
class Dewgong(Pokemon2):
    "Dewgong"
    def __init__(self,name="Dewgong",type1="Water",type2="Ice",nature="None",level=100,happiness=255,hp=105,atk=50,defense=90,spatk=100,spdef=105,speed=70,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Thick Fat","Ice Scales","Ice Body"]),item=random.choice(["Leftovers","Wacan Berry","Sitrus Berry","Lum Berry","Life Orb","Razor Fang"])):
        if move =="None":
            avmoves=["Protect","Hidden Power","Ice Beam","Hydro Pump","Thunderbolt","Surf","Snowscape","Rain Dance","Frost Breath","Aurora Veil","Ice Shard","Sheer Cold","Signal Beam","Frost Breath","Perish Song","Fake Out","Drill Run","Aqua Jet","Rest"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rest" in moves:
...
class Altaria(Pokemon2):
    "Altaria"
    def __init__(self,name="Altaria",type1="Dragon",type2="Flying",nature="None",level=100,happiness=255,hp=75,atk=85,defense=90,spatk=90,spdef=105,speed=80,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Natural Cure","Cloud Nine"]),item=random.choice(["Leftovers","Altarianite","Apicot Berry","Power Herb","Petaya Berry","Dragon Fang"])):
        if move =="None":
...
class Zangoose(Pokemon2):
    ...
    def __init__(self,name="Zangoose",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=73,atk=115,defense=70,spatk=60,spdef=70,speed=100,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Toxic Boost","Tough Claws","Immunity"]),item=random.choice(["Life Orb","Salac Berry","Chople Berry","Liechi Berry"])):
        if move =="None":
            avmoves=["Protect","Clush Claw","Slash","Crunch","X-Scissor","Facade","Close Combat","Swords Dance","Razor Wind"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Lunatone(Pokemon2):
    "Lunatone"
    def __init__(self,name="Lunatone",type1="Rock",type2="Ghost",nature="None",level=100,happiness=255,hp=90,atk=55,defense=95,spatk=95,spdef=115,speed=60,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Levitate",item=random.choice(["Leftovers","Petaya Berry","Expert Belt"])):
        if move =="None":
...
class Solrock(Pokemon2):
    "Solrock"
    def __init__(self,name="Solrock",type1="Rock",type2="Fire",nature="None",level=100,happiness=255,hp=70,atk=45,defense=65,spatk=150,spdef=65,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Levitate",item=random.choice(["Leftovers","Liechi Berry","Passho Berry"])):
        if move =="None":
            avmoves=["Protect","Ancient Power","Hyper Beam","Psychic","Power Gem","Moonblast","Stone Edge","Morning Sun","Explosion","Trick Room","Solar Beam","Stealth Rock","Meteor Beam","Blast Burn","Fire Blast","Flamethrower","Zen Headbutt"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)              
...
class Whiscash(Pokemon2):
    ...
    def __init__(self,name="Whiscash",type1="Water",type2="Ground",nature="None",level=100,happiness=255,hp=115,atk=85,defense=73,spatk=80,spdef=71,speed=60,hpev=0,atkev=252,defev=252,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Oblivious","Anticipation","Adaptability"]),item=random.choice(["Leftovers","Rindo Berry","Zoom Lens"])):
        if move =="None":
            avmoves=["Protect","Ancient Power","Ice Beam","Surf","Power Gem","Hydro Pump","Stone Edge","Earthquake","Rest","Magnitude","Future Sight","Fissure","Dragon Dance","Discharge","Waterfall","Blizzard"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rest" in moves:
...
class Crawdaunt(Pokemon2):
    "Crawdaunt"
    def __init__(self,name="Crawdaunt",type1="Water",type2="Dark",nature="None",level=100,happiness=255,hp=83,atk=120,defense=95,spatk=90,spdef=80,speed=55,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Adaptability","Shell Armor"]),item=random.choice(["Leftovers","Focus Sash","Wacan Berry","Life Orb","Choice Scarf"])):
        if move =="None":
...
class Claydol(Pokemon2):
    "Claydol"
    def __init__(self,name="Claydol",type1="Ground",type2="Psychic",nature="None",level=100,happiness=255,hp=70,atk=70,defense=105,spatk=90,spdef=120,speed=75,hpev=0,atkev=0,defev=252,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability="Levitate",item=random.choice(["Leftovers","Ganlon Berry","Sitrus Berry","Kasib Berry","Hard Stone","Wise Glasses","Quick Claw"])):
        if move =="None":
...
class Cyclizar(Pokemon2):
    def __init__(self,name="Cyclizar",type1="Dragon",type2="Normal",nature="None",level=100,happiness=255,hp=70,atk=95,defense=65,spatk=85,spdef=65,speed=121,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Regenerator","Shed Skin"]),item="Leftovers"):
        if move =="None":
...
class Banette(Pokemon2):
    ...
    def __init__(self,name="Banette",type1="Ghost",type2="None",nature="None",level=100,happiness=255,hp=64,atk=115,defense=65,spatk=73,spdef=63,speed=65,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Insomnia","Frisk","Prankster"]),item=random.choice(["Leftovers","Banettite","Liechi Berry","Ghost Gem"])):
        if move =="None":
            avmoves=["Protect","Recover","Knock Off","Crunch","Phantom Force","Assurance","Hypnosis","Shadow Ball","Toxic","Thunder Wave","Will-O-Wisp","Destiny Bond","Double-Edge","Shadow Sneak","Shadow Claw","Gunk Shot","Destiny Bond","Sucker Punch"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)          
...
class Glalie(Pokemon2):
    "Glalie"
    def __init__(self,name="Glalie",type1="Ice",type2="Rock",nature="None",level=100,happiness=255,hp=80,atk=80,defense=80,spatk=100,spdef=80,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Inner Focus","Moody","Refrigerate"]),item=random.choice(["Focus Sash","Glalitite","Scope Lens"])):
        if move =="None":
...
class Walrein(Pokemon2):
    "Walrein"
    def __init__(self,name="Walrein",type1="Ice",type2="Water",nature="None",level=100,happiness=255,hp=110,atk=80,defense=95,spatk=105,spdef=95,speed=65,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Thick Fat","Ice Body","Fur Coat"]),item=random.choice(["Leftovers","Heavy-Duty Boots","Salac Berry","Sitrus Berry","Expert Belt","Quick Claw","Bright Powder"])):
        if move =="None":
            avmoves=["Protect","Slack Off","Surf","Crunch","Ice Beam","Blizzard","Freeze-Dry","Ice Fang","Rest","Snowscape","Hyper Beam","Earthquake","Icicle Spear","Iron Head","Swords Dance","Liquidation","Frost Breath","Yawn","Super Fang","Aqua Ring","Sheer Cold","Toxic"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)         
...
class Huntail(Pokemon2):
    "Huntail"
    def __init__(self,name="Huntail",type1="Water",type2="Dark",nature="None",level=100,happiness=255,hp=95,atk=114,defense=105,spatk=94,spdef=75,speed=52,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Intimidate","Defiant","Moxie"]),item=random.choice(["Leftovers","White Herb","Liechi Berry"])):
        if move =="None":
...
class Gorebyss(Pokemon2):
    "Gorebyss"
    def __init__(self,name="Gorebyss",type1="Water",type2="Fairy",nature="None",level=100,happiness=255,hp=55,atk=84,defense=105,spatk=114,spdef=75,speed=100,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Regenerator","Dazzling","Swift Swim","Water Absorb"]),item=random.choice(["Leftovers","White Herb","Petaya Berry"])):
        if move =="None":
...
class Salamence(Pokemon2):
    ...
    def __init__(self,name="Salamence",type1="Dragon",type2="Flying",nature="None",level=100,happiness=255,hp=95,atk=135,defense=80,spatk=110,spdef=80,speed=100,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Moxie"]),item=random.choice(["Life Orb","Heavy-Duty Boots","Salamencite","Yache Berry","Petaya Berry","Dragon Gem","White Herb","Expert Belt","Cheri Berry","King's Rock"])):
        if move =="None":
            avmoves=["Protect","Stone Edge","Dragon Claw","Flamethrower","Crunch","Zen Headbutt","Double-Edge","Fire Blast","Earthquake","Dragon Dance","Roost","Thunder Fang","Hydro Pump","Heat Wave","Draco Meteor","Outrage","Rock Slide"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if name=="Salamence":
...
class Latias(Pokemon2):
    "Latias"
    def __init__(self,name="Latias",type1="Dragon",type2="Psychic",nature="None",level=100,happiness=255,hp=80,atk=80,defense=90,spatk=110,spdef=130,speed=110,hpev=252,atkev=0,defev=4,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability="Levitate",item=random.choice(["Soul Dew","Leftovers","Choice Specs","Choice Scarf","Latiasite","Yache Berry","Colbur Berry","Lum Berry","Bright Powder"])):
        if move =="None":
...
class Latios(Pokemon2):
    "Latios"
    def __init__(self,name="Latios",type1="Dragon",type2="Psychic",nature="None",level=100,happiness=255,hp=80,atk=90,defense=80,spatk=130,spdef=110,speed=110,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Levitate",item=random.choice(["Choice Scarf","Choice Specs","Soul Dew","Latiosite","Lum Berry","Expert Belt","Haban Berry"])):
        if move =="None":
            avmoves=["Protect","Hyper Beam","Luster Purge","Zen Headbutt","Dragon Pulse","Psychic","Calm Mind","Ice Beam","Thunderbolt","Shadow Ball","Draco Meteor","Dragon Dance","Recover","Dragon Claw","Shadow Claw"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Torterra(Pokemon2):
    "Torterra"
    def __init__(self,name="Torterra",type1="Grass",type2="Ground",nature="None",level=100,happiness=255,hp=95,atk=109,defense=105,spatk=75,spdef=85,speed=56,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Overgrow","Rock Head","Shell Armor"]),item=random.choice(["Choice Band","Leftovers","Yache Berry","Bright Powder"])):
        if move =="None":
...
class Empoleon(Pokemon2):
    "Empoleon"
    def __init__(self,name="Empoleon",type1="Water",type2="Steel",nature="None",level=100,happiness=255,hp=84,atk=86,defense=88,spatk=111,spdef=101,speed=60,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Torrent","Competitive","Adaptability"]),item=random.choice(["Leftovers","Shuca Berry","Chople Berry","Petaya Berry"])):
        if move =="None":
...
class Roserade(Pokemon2):
    "Roserade"
    def __init__(self,name="Roserade",type1="Grass",type2="Poison",nature="None",level=100,happiness=255,hp=60,atk=70,defense=65,spatk=125,spdef=105,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Technician","Poison Touch","Natural Cure"]),item=random.choice(["Heavy-Duty Boots","Black Sludge","Rocky Helmet","Lum Berry","Leftovers","Choice Scarf","White Herb","Big Root","Rose Incense","Miracle Seed"])):
        if move =="None":
...
class Stonjourner(Pokemon2):
    def __init__(self,name="Stonjourner",type1="Rock",type2="None",nature="None",level=100,happiness=255,hp=100,atk=125,defense=135,spatk=20,spdef=50,speed=80,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Power Spot"]),item=random.choice(["Leftovers"])):
        if move =="None":
            avmoves=["Protect","Stealth Rock","Heavy Slam","Rock Slide","Stone Edge","Rock Polish","Body Slam","Low Kick","Bulldoze"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)
...
class Bastiodon(Pokemon2):
    "Bastiodon"
    def __init__(self,name="Bastiodon",type1="Rock",type2="Steel",nature="None",level=100,happiness=255,hp=70,atk=78,defense=168,spatk=47,spdef=138,speed=30,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sturdy","Dauntless Shield","Soundproof","Solid Rock"]),item=random.choice(["Leftovers","Shuca Berry","Air Balloon","Muscle Band"])):
        if move =="None":
            avmoves=["Protect","Iron Defense","Iron Head","Crunch","Stone Edge","Heavy Slam","Fire Blast","Stealth Rock","Fire Blast"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class WGastrodon(Pokemon2):
    "Gastrodon"
    def __init__(self,name="West Sea Gastrodon",type1="Water",type2="Ground",nature="None",level=100,happiness=255,hp=111,atk=83,defense=68,spatk=92,spdef=82,speed=39,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Storm Drain","Sand Force"]),item=random.choice(["Leftovers","Rindo Berry","Heavy-Duty Boots","Apicot Berry"])):
        if move =="None":
            avmoves=["Protect","Earth Power","Recover","Hydro Pump","Ice Beam","Stealth Rock","Light Screen","Reflect","Chilling Water","Yawn","Sludge Wave","Counter"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)  
...
class Ambipom(Pokemon2):
    "Ambipom"
    def __init__(self,name="Ambipom",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=75,atk=100,defense=66,spatk=60,spdef=66,speed=115,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Skill Link","Technician"]),item=random.choice(["Leftovers","Life Orb","Flying Gem","Focus Sash","Normal Gem","Bright Powder"])):
        if move =="None":
...
class Mismagius(Pokemon2):
    "Mismagius"
    def __init__(self,name="Mismagius",type1="Ghost",type2="Fairy",nature="None",level=100,happiness=255,hp=70,atk=65,defense=70,spatk=110,spdef=110,speed=110,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Levitate",item=random.choice(["Leftovers","Kasib Berry","Salac Berry","Sitrus Berry","Colbur Berry","Spell Tag"])):
        if move =="None":
...
class Skuntank(Pokemon2):
    "Skuntank"
    def __init__(self,name="Skuntank",type1="Poison",type2="Dark",nature="None",level=100,happiness=255,hp=103,atk=103,defense=67,spatk=91,spdef=61,speed=84,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Stench","Aftermath","Poison Touch"]),item=random.choice(["Rocky Helmet","Black Sludge","Black Glasses","Choice Band","Choice Scarf","Shuca Berry","Bright Powder"])):
        if move =="None":
...
class Honchkrow(Pokemon2):
    "Honchkrow"
    def __init__(self,name="Honchkrow",type1="Dark",type2="Flying",nature="None",level=100,happiness=255,hp=100,atk=125,defense=60,spatk=105,spdef=60,speed=96,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Super Luck","Moxie","Insomnia","Prankster"]),item=random.choice(["Scope Lens","Heavy-Duty Boots","Salac Berry","Charti Berry","Choice Scarf","Dark Gem","Expert Belt","Sharp Beak"])):
        if move =="None":
...
class Spiritomb(Pokemon2):
    "Spiritomb"
    def __init__(self,name="Spiritomb",type1="Ghost",type2="Dark",nature="None",level=100,happiness=255,hp=100,atk=92,defense=108,spatk=92,spdef=108,speed=35,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Pressure","Intimidate"]),item=random.choice(["Choice Band","Leftovers","Sitrus Berry","Rocky Helmet"])):
        if move =="None":
...
class Whimsicott(Pokemon2):
    def __init__(self,name="Whimsicott",type1="Grass",type2="Fairy",nature="None",level=100,happiness=255,hp=60,atk=67,defense=85,spatk=77,spdef=75,speed=115,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability="Prankster",item=random.choice(["Leftovers","Occa Berry","Mental Herb"])):
        if move =="None":
...
class Garchomp(Pokemon2):
    "Garchomp"
    def __init__(self,name="Garchomp",type1="Dragon",type2="Ground",nature="None",level=100,happiness=255,hp=108,atk=130,defense=95,spatk=80,spdef=85,speed=102,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Rough Skin","Sand Veil"]),item=random.choice(["Life Orb","Yache Berry","Leftovers","Rocky Helmet","Garchompite","Salac Berry","Choice Scarf","Focus Sash","Bright Powder"])):
        if move =="None":
...
class Hippowdon(Pokemon2):
    "Hippowdon"
    def __init__(self,name="Hippowdon",type1="Ground",type2="None",nature="None",level=100,happiness=255,hp=108,atk=112,defense=118,spatk=68,spdef=72,speed=47,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability="Sand Stream",item=random.choice(["Leftovers","Rocky Helmet","Passho Berry","Quick Claw"])):
        if move =="None":
...
class Abomasnow(Pokemon2):
    "Abomasnow"
    def __init__(self,name="Abomasnow",type1="Grass",type2="Ice",nature="None",level=100,happiness=255,hp=90,atk=92,defense=75,spatk=92,spdef=85,speed=60,hpev=220,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=36,maxiv="No",move="None", ability=random.choice(["Snow Warning","Soundproof"]),item=random.choice(["Leftovers","Focus Sash","Babiri Berry","Icy Rock","Abomasite","Occa Berry","Scope Lens","Zoom Lens"])):
        if move =="None":
            a=random.randint(1,2)
            if a==1:
                avmoves=["Protect","Wood Hammer","Icicle Crash","Blizzard","Ice Shard","Energy Ball","Earth Power","Aurora Veil","Substitute","Grass Knot","Earthquake","Brick Break"]
                moves=moveset(type1,type2,avmoves,name=name)
            if a==2:
                nature="Modest"
                ability="Snow Warning"
...
class Weavile(Pokemon2):
    "Weavile"
    def __init__(self,name="Weavile",type1="Dark",type2="Ice",nature="None",level=100,happiness=255,hp=70,atk=120,defense=65,spatk=45,spdef=85,speed=125,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Pressure","Infiltrator"]),item=random.choice(["Heavy-Duty Boots","Choice Band","Chople Berry","Dark Gem","Ice Gem","Focus Sash","Razor Claw"])):
        if move =="None":
...
class Magnezone(Pokemon2):
    "Magnezone"
    def __init__(self,name="Magnezone",type1="Electric",type2="Steel",nature="None",level=100,happiness=255,hp=70,atk=70,defense=115,spatk=130,spdef=90,speed=60,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sturdy","Analytic","Magnet Pull","Levitate"]),item=random.choice(["Leftovers","Choice Specs","Air Balloon","Focus Sash","Shuca Berry","Quick Claw","Bright Powder"])):
        if move =="None":
            avmoves=["Protect","Hidden Power","Flash Cannon","Thunderbolt","Iron Defense","Electric Terrain","Steel Beam","Signal Beam","Discharge","Zap Cannon","Lock-On","Thunder Wave","Mirror Coat","Toxic","Explosion","Reflect"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)      
...
class PorygonZ(Pokemon2):
    "Porygon-Z"
    def __init__(self,name="Porygon-Z",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=85,atk=80,defense=70,spatk=135,spdef=75,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=4,speedev=252,maxiv="No",move="None", ability=random.choice(["Adaptability","Download"]),item=random.choice(["Choice Scarf","Life Orb","Chople Berry","Sitrus Berry","Expert Belt","Bright Powder"])):
        if move =="None":
...
class Ursaluna(Pokemon2):
    "Ursaluna"
    def __init__(self,name="Ursaluna",type1="Normal",type2="Ground",nature="None",level=100,happiness=255,hp=130,atk=140,defense=105,spatk=45,spdef=80,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Guts","Rock Head","Unnerve"]),item="Leftovers"):
        if move =="None":
            avmoves=["Protect","Bulk Up","Double-Edge","High Horsepower","Head Smash","Headlong Rush","Moonlight","Thrash"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if ability=="Guts":
...
class Dusknoir(Pokemon2):
    "Dusknoir"
    def __init__(self,name="Dusknoir",type1="Ghost",type2="None",nature="None",level=100,happiness=255,hp=60,atk=110,defense=135,spatk=65,spdef=135,speed=45,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move="None", ability=random.choice(["Pressure","Levitate","Hustle"]),item=random.choice(["Choice Band","Leftovers","Chesto Berry","Sitrus Berry","Ganlon Berry","Lum Berry","Apicot Berry","Muscle Band","Bright Powder"])):
        if move =="None":
            avmoves=["Protect","Will-O-Wisp","Thunder Wave","Shadow Punch","Hex","Calm Mind","Rest","Metronome","Destiny Bond","Future Sight","Bulldoze","Pain Split","Thunder Punch"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Froslass(Pokemon2):
    "Froslass"
    def __init__(self,name="Froslass",type1="Ice",type2="Ghost",nature="None",level=100,happiness=255,hp=70,atk=60,defense=70,spatk=110,spdef=70,speed=110,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Snow Cloak","Levitate"]),item=random.choice(["Focus Sash","Ice Gem","Petaya Berry","Lax Incense"])):
        if move =="None":
...
class WRotom(Pokemon2):
    "Wash Rotom"
    def __init__(self,name="Wash Rotom",type1="Electric",type2="Water",nature="None",level=100,happiness=255,hp=50,atk=65,defense=107,spatk=105,spdef=107,speed=86,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=4,maxiv="No",move="None", ability=random.choice(["Levitate"]),item=random.choice(["Leftovers","Choice Scarf","Wide Lens"])):
        if move =="None":
...
class Heatran(Pokemon2):
    "Heatran"
    def __init__(self,name="Heatran",type1="Fire",type2="Steel",nature="None",level=100,happiness=255,hp=91,atk=90,defense=106,spatk=130,spdef=106,speed=77,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Flash Fire"]),item=random.choice(["Leftovers","Air Balloon","Passho Berry","Shuca Berry","Focus Sash","Quick Claw","Bught Powder"])):
        if move =="None":
            avmoves=["Protect","Fire Blast","Flash Cannon","Ancient Power","Earth Power","Steel Beam","Dark Pulse","Solar Beam","Substitute","Fire Fang","Earthquake","Crunch","Stone Edge","Dragon Pulse"]
...
class Regigigas(Pokemon2):
    "Regigigas"
    def __init__(self,name="Regigigas",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=110,atk=160,defense=110,spatk=80,spdef=110,speed=100,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Slow Start"]),item=random.choice(["Leftovers","Bright Powder","Shell Bell","Chople Berry","Life Orb"])):
        if move =="None":
...
class Bronzong(Pokemon2):
    "Bronzong"
    def __init__(self,name="Bronzong",type1="Steel",type2="Psychic",nature="None",level=100,happiness=255,hp=67,atk=89,defense=116,spatk=79,spdef=116,speed=33,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move="None", ability=random.choice(["Levitate","Heatproof","Heavy Metal"]),item=random.choice(["Leftovers","Occa Berry","Sitrus Berry","Lum Berry","Rocky Helmet","Iron Ball","Twisted Spoon"])):
        if move =="None":
...
class Excadrill(Pokemon2):
    "Excadrill"
    def __init__(self,name="Excadrill",type1="Ground",type2="Steel",nature="None",level=100,happiness=255,hp=110,atk=135,defense=60,spatk=50,spdef=65,speed=88,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sand Rush","Sand Force"]),item=random.choice(["Leftovers","Air Balloon","Life Orb","Liechi Berry","Focus Sash","Chople Berry"])):
        if move =="None":
...
class Conkeldurr(Pokemon2):
    "Conkeldurr"
    def __init__(self,name="Conkeldurr",type1="Fighting",type2="None",nature="None",level=100,happiness=255,hp=105,atk=140,defense=95,spatk=55,spdef=65,speed=45,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Guts","Sheer Force","Iron Fist"]),item=random.choice(["Life Orb","Fighting Gem"])):
        if move =="None":
...
class Seismitoad (Pokemon2):
    "Seismitoad"
    def __init__(self,name="Seismitoad",type1="Water",type2="Ground",nature="None",level=100,happiness=255,hp=105,atk=95,defense=75,spatk=85,spdef=75,speed=74,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Poison Touch","Swift Swim","Drizzle"]),item=random.choice(["Leftovers","Salac Berry","Rindo Berry","Life Orb"])):
        if move =="None":
...
class Leavanny(Pokemon2):
    "Leavanny"
    def __init__(self,name="Leavanny",type1="Bug",type2="Grass",nature="None",level=100,happiness=255,hp=75,atk=103,defense=80,spatk=70,spdef=80,speed=92,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=4,speedev=252,maxiv="No",move="None", ability=random.choice(["Chlorophyll","Sharpness","Poison Heal"]),item=random.choice(["Leftovers","Coba Berry","Focus Sash"])):
        if move =="None":
...
class Basculegion (Pokemon2):
    "Basculegion"
    def __init__(self,name="Basculegion",type1="Water",type2="Ghost",nature="None",level=100,happiness=255,hp=120,atk=112,defense=65,spatk=80,spdef=75,speed=78,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Adaptability","Swift Swim"]),item=random.choice(["Leftovers","Salac Berry"])):
        if move =="None":
            avmoves=["Protect","Wave Crash","Crunch","Aqua Tail","Aqua Jet","Waterfall","Zen Headbutt","Destiny Bond","Last Respects","Flail","Double-Edge"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Krookodile(Pokemon2):
    "Krookodile"
    def __init__(self,name="Krookodile",type1="Ground",type2="Dark",nature="None",level=100,happiness=255,hp=95,atk=117,defense=80,spatk=65,spdef=70,speed=92,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Moxie"]),item=random.choice(["Leftovers","Chople Berry","Black Glasses","Expert Belt","Choice Band","Liechi Berry"])):
        if move =="None":
            avmoves=["Protect","Wicked Blow","Earthquake","Stone Edge","Crunch","Foul Play","Outrage","Darkest Lariat","Scale Shot","Dig","Fire Fang","Aqua Tail"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Scrafty(Pokemon2):
    "Scrafty"
    def __init__(self,name="Scrafty",type1="Dark",type2="Fighting",nature="None",level=100,happiness=255,hp=65,atk=90,defense=115,spatk=45,spdef=115,speed=58,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Intimidate","Moxie","Shed Skin"]),item=random.choice(["Leftovers"])):
        if move =="None":
...
class Archeops(Pokemon2):
    "Archeops"
    def __init__(self,name="Archeops",type1="Rock",type2="Flying",nature="None",level=100,happiness=255,hp=75,atk=150,defense=55,spatk=122,spdef=55,speed=120,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Defeatist","Intimidate"]),item=random.choice(["Flying Gem","Life Orb","Sitrus Berry","Enigma Berry","Choice Band"])):
        if move =="None":
...
class Reuniclus(Pokemon2):
    "Reuniclus"
    def __init__(self,name="Reuniclus",type1="Psychic",type2="None",nature="None",level=100,happiness=255,hp=110,atk=65,defense=75,spatk=125,spdef=85,speed=30,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability="Magic Guard",item=random.choice(["Leftovers","Life Orb","Colbur Berry","Toxic Orb"])):
        if move =="None":
...
class Swanna(Pokemon2):
    "Swanna"
    def __init__(self,name="Swanna",type1="Water",type2="Flying",nature="None",level=100,happiness=255,hp=75,atk=107,defense=63,spatk=107,spdef=63,speed=108,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None",ability=random.choice(["Hydration","No Guard","Drizzle"]),item=random.choice(["Leftovers","Wacan Berry","Focus Sash"])):
        if move =="None":
...
class Vanilluxe(Pokemon2):
    "Vanilluxe"
    def __init__(self,name="Vanilluxe",type1="Ice",type2="None",nature="None",level=100,happiness=255,hp=71,atk=65,defense=75,spatk=130,spdef=85,speed=109,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Snow Warning",item=random.choice(["Leftovers","Occa Berry","Sitrus Berry"])):
        if move =="None":
...
class Escavalier(Pokemon2):
    "Escavalier"
    def __init__(self,name="Escavalier",type1="Bug",type2="Steel",nature="None",level=100,happiness=255,hp=70,atk=135,defense=105,spatk=60,spdef=105,speed=20,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Shell Armor","Overcoat","Swarm","Filter"]),item=random.choice(["Leftovers","Occa Berry","Quick Claw"])):
        if move =="None":
...
class Jellicent(Pokemon2):
    ...
    def __init__(self,name="Jellicent",type1="Water",type2="Ghost",nature="None",level=100,happiness=255,hp=100,atk=60,defense=70,spatk=100,spdef=105,speed=60,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Water Absorb","Water Bubble","Cursed Body"]),item=random.choice(["Leftovers","Rindo Berry","Ghost Gem","Expert Belt"])):
        if move =="None":
            avmoves=["Protect","Night Shade","Acid Armor","Rain Dance","Recover","Will-O-Wisp","Hex","Destiny Bond","Pain Split","Water Spout","Hydro Pump","Surf","Scald","Psychic"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                        
...
class Galvantula(Pokemon2):
    "Galvantula"
    def __init__(self,name="Galvantula",type1="Bug",type2="Electric",nature="None",level=100,happiness=255,hp=70,atk=77,defense=60,spatk=107,spdef=60,speed=108,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Swarm","Compound Eyes","Unnerve"]),item=random.choice(["Life Orb","Heavy-Duty Boots","Petaya Berry","Sitrus Berry","Scope Lens"])):
        if move =="None":
...
class Ferrothorn(Pokemon2):
    "Ferrothorn"
    def __init__(self,name="Ferrothorn",type1="Grass",type2="Steel",nature="None",level=100,happiness=255,hp=74,atk=94,defense=131,spatk=54,spdef=116,speed=20,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move="None", ability=random.choice(["Iron Barbs","Anticipation","Shell Armor"]),item=random.choice(["Leftovers","Rocky Helmet","Occa Berry","Apicot Berry","Choice Band"])):
        if move =="None":
...
class Eelektross(Pokemon2):
    "Eelektross"
    def __init__(self,name="Eelektross",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=95,atk=115,defense=80,spatk=115,spdef=80,speed=50,hpev=0,atkev=252,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Levitate","Fatal Precision"]),item=random.choice(["Leftovers","Assault Vest","Salac Berry","Choice Band","Magnet"])):
        if move =="None":
...
class Haxorus(Pokemon2):
    "Haxorus"
    def __init__(self,name="Haxorus",type1="Dragon",type2="Steel",nature="None",level=100,happiness=255,hp=76,atk=147,defense=90,spatk=60,spdef=70,speed=97,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Mold Breaker","Sheer Force","Unnerve"]),item=random.choice(["Leftovers","Dragon Gem","Focus Sash","Choice Scarf","Yache Berry","Persim Berry"])):
        if move =="None":
            avmoves=["Protect","Outrage","Swords Dance","Dual Chop","Dragon Dance","Dragon Claw","Crunch","Scale Shot","Earthquake","Close Combat","First Impression","Iron Head","Brick Break","Razor Wind"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)          
...
class Accelgor(Pokemon2):
    "Accelgor"
    def __init__(self,name="Accelgor",type1="Bug",type2="Dark",nature="None",level=100,happiness=255,hp=80,atk=70,defense=40,spatk=110,spdef=60,speed=145,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sticky Hold","Sheer Force","Unburden","Adaptability"]),item=random.choice(["Leftovers","Petaya Berry","Bright Powder"])):
        if move =="None":
...
class Druddigon(Pokemon2):
    "Druddigon"
    def __init__(self,name="Druddigon",type1="Dragon",type2="Rock",nature="None",level=100,happiness=255,hp=90,atk=120,defense=90,spatk=60,spdef=90,speed=98,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sheer Force","Rough Skin","Mold Breaker"]),item=random.choice(["Life Orb","Yache Berry","Salac Berry","Rocky Helmet"])):
        if move =="None":
...
class Golurk(Pokemon2):
    "Golurk"
    def __init__(self,name="Golurk",type1="Ground",type2="Ghost",nature="None",level=100,happiness=255,hp=100,atk=124,defense=90,spatk=55,spdef=90,speed=55,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["No Guard","Iron Fist"]),item=random.choice(["Leftovers","Assault Vest","Ghost Gem","Lum Berry"])):
        if move =="None":
            avmoves=["Protect","Phantom Force","Hammer Arm","Shadow Sneak","Earthquake","Dynamic Punch","Stomping Tantrum","High Horsepower","Magnitude","Headlong Rush","Substitute"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)       
...
class Bisharp(Pokemon2):
    "Bisharp"
    def __init__(self,name="Bisharp",type1="Dark",type2="Steel",nature="None",level=100,happiness=255,hp=65,atk=125,defense=100,spatk=60,spdef=70,speed=70,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Defiant","Pressure"]),item=random.choice(["Eviolite","Chople Berry"])):
        if move =="None":
...
class Bouffalant(Pokemon2):
    "Bouffalant"
    def __init__(self,name="Bouffalant",type1="Normal",type2="Ground",nature="None",level=100,happiness=255,hp=95,atk=110,defense=95,spatk=40,spdef=95,speed=105,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sap Sipper","Reckless","Bull Rush"]),item=random.choice(["Leftovers","Normal Gem","Life Orb","Sitrus Berry"])):
        if move =="None":
...
class Braviary(Pokemon2):
    "Braviary"
    def __init__(self,name="Braviary",type1="Normal",type2="Flying",nature="None",level=100,happiness=255,hp=100,atk=123,defense=75,spatk=57,spdef=75,speed=90,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Defiant","Sheer Force"]),item=random.choice(["Life Orb","Fighting Gem","Normal Gem","White Herb","Choice Band","Persim Berry","Wacan Berry"])):
        if move =="None":
...
class Heatmor(Pokemon2):
    "Heatmor"
    def __init__(self,name="Heatmor",type1="Fire",type2="Dragon",nature="None",level=100,happiness=255,hp=100,atk=77,defense=86,spatk=135,spdef=86,speed=45,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Flash Fire","Fatal Precision"]),item=random.choice(["Leftovers","Salac Berry","Focus Sash"])):
        if move =="None":
...
class Hydreigon(Pokemon2):
    "Hydreigon"
    def __init__(self,name="Hydreigon",type1="Dark",type2="Dragon",nature="None",level=100,happiness=255,hp=92,atk=105,defense=90,spatk=125,spdef=90,speed=98,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Levitate"]),item=random.choice(["Leftovers","Roseli Berry","Petaya Berry","Choice Specs","White Herb"])):
        if move =="None":
...
class Pyroar(Pokemon2):
    "Pyroar"
    def __init__(self,name="Pyroar",type1="Fire",type2="Normal",nature="None",level=100,happiness=255,hp=86,atk=68,defense=72,spatk=109,spdef=66,speed=106,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Moxie","Adaptability","Unnerve"]),item=random.choice(["Leftovers"])):
        if move =="None":
...
class Bewear(Pokemon2):
    "Bewear"
    def __init__(self,name="Bewear",type1="Normal",type2="Fighting",nature="None",level=100,happiness=255,hp=120,atk=125,defense=80,spatk=55,spdef=60,speed=60,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Fluffy","Unnerve"]),item=random.choice(["Leftovers","Normal Gem"])):
        if move =="None":
...
class Slowbro(Pokemon2):
    "Slowbro"
    def __init__(self,name="Slowbro",type1="Water",type2="Psychic",nature="None",level=100,happiness=255,hp=95,atk=75,defense=110,spatk=100,spdef=80,speed=30,hpev=0,atkev=0,defev=252,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Regenerator","Own Tempo"]),item=random.choice(["Colbur Berry","Heavy-Duty Boots","Slowbronite","Apicot Berry","Shell Bell"])):
        if move =="None":
...
class Corviknight(Pokemon2):
    "Corviknight"
    def __init__(self,name="Corviknight",type1="Flying",type2="Steel",nature="None",level=100,happiness=255,hp=98,atk=87,defense=105,spatk=53,spdef=85,speed=67,hpev=252,atkev=252,defev=4,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Pressure","Mirror Armor","Unnerve"]),item=random.choice(["Leftovers","Rocky Helmet","Lum Berry","Occa Berry"])):
        if move =="None":
...
class Sandaconda(Pokemon2):
    "Sandaconda"
    def __init__(self,name="Sandaconda",type1="Ground",type2="None",nature="None",level=100,happiness=255,hp=72,atk=107,defense=125,spatk=65,spdef=70,speed=71,hpev=252,atkev=252,defev=4,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Sand Spit","Sand Veil","Shed Skin"]),item=random.choice(["Leftovers","Rocky Helmet"])):
        if move =="None":
...
class Dracozolt(Pokemon2):
    "Dracozolt"
    def __init__(self,name="Dracozolt",type1="Electric",type2="Dragon",nature="None",level=100,happiness=255,hp=90,atk=100,defense=90,spatk=80,spdef=70,speed=75,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sand Rush","Hustle"]),item=random.choice(["Leftovers","Choice Scarf","Life Orb"])):
        if move =="None":
...
class Raichu(Pokemon2):
    ...
    def __init__(self,name="Raichu",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=70,atk=100,defense=55,spatk=110,spdef=80,speed=100,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Static","Lightning Rod"]),item=random.choice(["Leftovers","Air Balloon","Salac Berry","Electric Gem","Liechi Berry","Life Orb","Focus Sash"])):
        if move =="None":
            avmoves=["Extreme Speed","Volt Tackle","Iron Tail","Thunderbolt","Electroweb","Electro Ball","Thunder","Fake Out","Calm Mind","Double Team","Signal Beam","Focus Blast","Thunder Wave","Brick Break","Knock Off","Return","Grass Knot","Swagger"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Sandslash(Pokemon2):
    "Sandslash"
    def __init__(self,name="Sandslash",type1="Ground",type2="None",nature="None",level=100,happiness=255,hp=75,atk=100,defense=110,spatk=25,spdef=55,speed=120,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sand Rush","Sand Veil","Sand Force"]),item=random.choice(["Leftovers","Salac Berry"])):
        if move =="None":
...
class Clefable(Pokemon2):
    "Clefable"
    def __init__(self,name="Clefable",type1="Fairy",type2="None",nature="None",level=100,happiness=255,hp=95,atk=76,defense=73,spatk=95,spdef=90,speed=60,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Magic Guard","Cute Charm"]),item=random.choice(["Leftovers","Life Orb","Unaware","Steel Gem","Sitrus Berry"])):
        if move =="None":
...
class Vileplume(Pokemon2):
    def __init__(self,name="Vileplume",type1="Grass",type2="Poison",nature="None",level=100,happiness=255,hp=75,atk=80,defense=85,spatk=100,spdef=90,speed=100,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Chlorophyll","Effect Spore"]),item=random.choice(["Black Sludge","Grass Gem","Quick Claw"])):
        if move =="None":
...
class Venomoth(Pokemon2):
    def __init__(self,name="Venomoth",type1="Bug",type2="Psychic",nature="None",level=100,happiness=255,hp=70,atk=55,defense=65,spatk=100,spdef=75,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Tinted Lens","Shield Dust","Wonder Skin"]),item=random.choice(["Black Sludge","Petaya Berry","Wide Lens"])):
        if move =="None":
...
class Persian(Pokemon2):
    def __init__(self,name="Persian",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=65,atk=100,defense=60,spatk=60,spdef=65,speed=115,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Technician","Feline Prowess","Limber","Unnerve"]),item="Leftovers"):
        if move =="None":
...
class Hypno(Pokemon2):
    def __init__(self,name="Hypno",type1="Psychic",type2="None",nature="None",level=100,happiness=255,hp=100,atk=53,defense=70,spatk=113,spdef=120,speed=67,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Psychic Surge","Magic Bounce","Bad Dreams"]),item=random.choice(["Psychic Seed","Terrain Extender","Sitrus Berry"])):
        if move =="None":
            avmoves=["Nasty Plot","Psyshock","Psychic","Dark Pulse","Hypnosis","Thunder Wave","Shadow Ball","Future Sight","Psycho Boost","Recover","Dream Eater"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
...
class Electrode(Pokemon2):
    "Electrode"
    def __init__(self,name="Electrode",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=60,atk=130,defense=50,spatk=130,spdef=50,speed=140,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Static","Galvanize","Soundproof"]),item=random.choice(["Leftovers","Lum Berry","Shuca Berry","Electric Gem","Focus Sash","Air Balloon"])):
        if move =="None":
...
class Marowak(Pokemon2):
    def __init__(self,name="Marowak",type1="Ground",type2="None",nature="None",level=100,happiness=255,hp=70,atk=100,defense=110,spatk=50,spdef=80,speed=45,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Rock Head","Bone Zone","Battle Armor"]),item=random.choice(["Leftovers","Yache Berry"])):
        if move =="None":
...
class Seaking(Pokemon2):
    def __init__(self,name="Seaking",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=80,atk=112,defense=80,spatk=45,spdef=80,speed=98,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Lightning Rod","Swift Swim","Rain Dish"]),item=random.choice(["Leftovers","Wacan Berry"])):
        if move =="None":
...
class Palafin(Pokemon2):
    def __init__(self,name="Palafin",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=100,atk=70,defense=72,spatk=53,spdef=62,speed=100,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Zero to Hero"]),item="Leftovers"):
        if move =="None":
            ...
            moves=moveset(type1,type2,avmoves,3,name=name)+["Jet Punch"]
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                                
#Mr.Mime
class MrMime(Pokemon2):
    def __init__(self,name="Mr.Mime",type1="Psychic",type2="Fairy",nature="None",level=100,happiness=255,hp=40,atk=35,defense=100,spatk=100,spdef=120,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Psychic Surge","Filter","Technician"]),item=random.choice(["Psychic Seed","Terrain Extender","Kasib Berry","Colbur Berry"])):
        if move =="None":
...
class Noctowl(Pokemon2):
    def __init__(self,name="Noctowl",type1="Normal",type2="Flying",nature="None",level=100,happiness=255,hp=110,atk=40,defense=80,spatk=96,spdef=106,speed=70,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Tinted Lens","Insomnia"]),item=random.choice(["Choice Specs","Life Orb","Flying Gem","Ganlon Berry"])):
        if move =="None":
...
class Sudowoodo(Pokemon2):
    def __init__(self,name="Sudowoodo",type1="Rock",type2="Grass",nature="None",level=100,happiness=255,hp=90,atk=100,defense=115,spatk=30,spdef=65,speed=30,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Rock Head","Sturdy"]),item=random.choice(["Life Orb","Liechi Berry"])):
        if move =="None":
...
class Jumpluff(Pokemon2):
    def __init__(self,name="Jumpluff",type1="Grass",type2="Flying",nature="None",level=100,happiness=255,hp=75,atk=85,defense=70,spatk=35,spdef=95,speed=110,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Chlorophyll","Fluffy","Aerilate"]),item=random.choice(["Life Orb","Yache Berry","Focus Sash"])):
        if move =="None":
...
class Slowking(Pokemon2):
    "Slowking"
    def __init__(self,name="Slowking",type1="Water",type2="Psychic",nature="None",level=100,happiness=255,hp=95,atk=65,defense=80,spatk=110,spdef=110,speed=30,hpev=0,atkev=0,defev=252,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Regenerator","Own Tempo"]),item=random.choice(["Leftovers","Lum Berry","Choice Specs","Expert Belt","Wise Glasses","Bright Powder"])):
        if move =="None":
            avmoves=["Hidden Power","Ice Beam","Slack Off","Psychic","Flamethrower","Surf","Thunderbolt","Iron Defense","Rain Dance","Yawn","Future Sight","Shadow Ball","Focus Blast","Scald","Nasty Plot","Blizzard"]
            moves=moveset(type1,type2,avmoves,3,name=name)+["Chilly Reception"]
        else:
            moves=move
...
class Forretress(Pokemon2):
    def __init__(self,name="Forretress",type1="Bug",type2="Steel",nature="None",level=100,happiness=255,hp=75,atk=90,defense=140,spatk=90,spdef=70,speed=20,hpev=252,atkev=0,defev=252,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability="Sturdy",item=random.choice(["Leftovers","Apicot Berry","Occa Berry","Iron Ball"])):
        if move =="None":
            avmoves=["Iron Defense","Gyro Ball","Heavy Slam","Explosion","Stealth Rock","Reflect","Rapid Spin","Body Press","Spikes","Bug Buzz","Pain Split","Zap Cannon","Earthquake","Light Screen","Toxic"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Reflect" in moves:
...
class Granbull(Pokemon2):
    def __init__(self,name="Grabull",type1="Fairy",type2="Fighting",nature="None",level=100,happiness=255,hp=90,atk=120,defense=75,spatk=60,spdef=60,speed=85,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Intimidate","Strong Jaw","Bull Rush","Quick Feet"]),item=random.choice(["Leftovers","Quick Claw"])):
        if move =="None":
...
class Shuckle(Pokemon2):
    def __init__(self,name="Shuckle",type1="Bug",type2="Rock",nature="None",level=100,happiness=255,hp=50,atk=10,defense=230,spatk=10,spdef=230,speed=5,hpev=252,atkev=0,defev=252,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Sturdy","Contrary","Solid Rock"]),item=random.choice(["Leftovers","Sitrus Berry","Rocky Helmet","Bright Powder"])):
        if move =="None":
            avmoves=["Iron Defense","Gyro Ball","Heavy Slam","Explosion","Stealth Rock","Reflect","Rapid Spin","Sticky Web","Cosmic Power","Skitter Smack","Substitute","Toxic","Stone Edge","Earthquake","Rest"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rest" in moves:
...
class Donphan(Pokemon2):
    def __init__(self,name="Donphan",type1="Ground",type2="None",nature="None",level=100,happiness=255,hp=90,atk=120,defense=120,spatk=60,spdef=70,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Sturdy","Technician","Battle Armor"]),item=random.choice(["Leftovers","Lum Berry","Quick Claw","Bright Powder","Focus Band","Razor Claw"])):
        if move =="None":
...
class Masquerain(Pokemon2):
    def __init__(self,name="Masquerain",type1="Bug",type2="Water",nature="None",level=100,happiness=255,hp=70,atk=60,defense=73,spatk=100,spdef=82,speed=85,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Tinted Lens","Intimidate","Unnerve"]),item=random.choice(["Leftovers","Focus Sash"])):
        if move =="None":
...
class Shedinja(Pokemon2):
    def __init__(self,name="Shedinja",type1="Bug",type2="Ghost",nature="None",level=100,happiness=255,hp=1,atk=135,defense=30,spatk=135,spdef=30,speed=40,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Wonder Guard"]),item=random.choice(["Focus Sash","Lum Berry","Quick Claw","Scope Lens","Heavy-Duty Boots","Safety Googles","Lax Incense"])):
        if move =="None":
...
class Sableye(Pokemon2):
    def __init__(self,name="Sableye",type1="Dark",type2="Ghost",nature="None",level=100,happiness=255,hp=50,atk=75,defense=100,spatk=65,spdef=100,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move="None", ability=random.choice(["Prankster"]),item=random.choice(["Leftovers","Sablenite","Ganlon Berry"])):
        if move =="None":
...
class Manectric(Pokemon2):
    def __init__(self,name="Manectric",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=70,atk=75,defense=60,spatk=115,spdef=60,speed=105,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Static","Lightning Rod"]),item=random.choice(["Manectite","Life Orb","Petaya Berry","Magnet"])):
        if move =="None":
            avmoves=["Protect","Volt Switch","Thunder","Crunch","Thunderbolt","Wild Charge","Hyper Beam","Thunder Wave","Flamethrower","Electric Terrain","Double Team","Rain Dance"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rain Dance" in moves:
...
class Grumpig(Pokemon2):
    def __init__(self,name="Grumpig",type1="Psychic",type2="Dark",nature="None",level=100,happiness=255,hp=100,atk=50,defense=75,spatk=115,spdef=120,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Thick Fat","Magic Guard","Own Tempo"]),item=random.choice(["Leftovers","Colbur Berry","Ganlon Berry","Salac Berry"])):
        if move =="None":
...
class Cherrim(Pokemon2):
    def __init__(self,name="Cherrim",type1="Grass",type2="None",nature="None",level=100,happiness=255,hp=70,atk=100,defense=70,spatk=60,spdef=78,speed=85,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Flower Gift",item=random.choice(["Leftovers","Miracle Seed","Grass Gem"])):
        if move =="None":
...
class Lumineon(Pokemon2):
    def __init__(self,name="Lumineon",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=79,atk=69,defense=76,spatk=129,spdef=69,speed=91,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=252,speedev=0,maxiv="No",move="None", ability=random.choice(["Storm Drain","Dazzling","Swift Swim"]),item=random.choice(["Leftovers"])):
        if move =="None":
            avmoves=["Protect","Aqua Jet","Tailwind","Ice Beam","Surf","Hydro Pump","U-turn","Bug Buzz","Hurricane","Icy Wind","Blizzard","Rain Dance"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)     
...
class Amoongus(Pokemon2):
    def __init__(self,name="Amoongus",type1="Grass",type2="Poison",nature="None",level=100,happiness=255,hp=114,atk=85,defense=70,spatk=85,spdef=80,speed=80,hpev=252,atkev=0,defev=172,spatkev=0,spdefev=84,speedev=0,maxiv="No",move="None", ability="Regenerator",item=random.choice(["Black Sludge","Rocky Helmet","Wiki Berry","Occa Berry","Ganlon Berry"])):
        if move =="None":
...
class Audino(Pokemon2):
    def __init__(self,name="Audino",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=103,atk=60,defense=86,spatk=60,spdef=86,speed=50,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move="None", ability="Regenerator",item=random.choice(["Leftovers","Audinite","Sitrus Berry","Shell Bell"])):
        if move =="None":
            avmoves=["Misty Terrain","Double-Edge","Moonblast","Zen Headbutt","Blizzard","Fire Blast","Thunder","Calm Mind"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)  
...
class Delcatty(Pokemon2):
    def __init__(self,name="Delcatty",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=70,atk=95,defense=95,spatk=65,spdef=85,speed=90,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move="None", ability=random.choice(["Magic Guard","Feline Prowess","Wonder Skin","Cute Charm"]),item=random.choice(["Leftovers"])):
        if move =="None":
...
class Sigilyph(Pokemon2):
    def __init__(self,name="Sigilyph",type1="Psychic",type2="Flying",nature="None",level=100,happiness=255,hp=72,atk=58,defense=80,spatk=113,spdef=80,speed=117,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Magic Guard","Tinted Lens"]),item=random.choice(["Leftovers","Life Orb"])):
        if move =="None":
            avmoves=["Air Slash","Psychic","Light Screen","Reflect","Tailwind","Esper Wing","Hurricane","Psycho Boost","Cosmic Power","Ice Beam","Ancient Power"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)    
...
class Simisage(Pokemon2):
    def __init__(self,name="Simisage",type1="Grass",type2="None",nature="None",level=100,happiness=255,hp=75,atk=98,defense=63,spatk=98,spdef=63,speed=101,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Overgrow",item=random.choice(["Leftovers","Salac Berry","Grass Gem"])):
        if move =="None":
...
class Simisear(Pokemon2):
    def __init__(self,name="Simisear",type1="Fire",type2="None",nature="None",level=100,happiness=255,hp=75,atk=98,defense=63,spatk=98,spdef=63,speed=101,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Blaze",item=random.choice(["Leftovers","Salac Berry","Fire Gem"])):
        if move =="None":
...
class Simipour(Pokemon2):
    def __init__(self,name="Simipour",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=75,atk=98,defense=63,spatk=98,spdef=63,speed=101,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Torrent",item=random.choice(["Leftovers","Salac Berry","Water Gem"])):
        if move =="None":
...
class Throh(Pokemon2):
    def __init__(self,name="Throh",type1="Fighting",type2="None",nature="None",level=100,happiness=255,hp=120,atk=100,defense=95,spatk=30,spdef=95,speed=45,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability="Guts",item=random.choice(["Flame Orb","Payapa Berry"])):
        if move =="None":
...
#Sawk
class Sawk(Pokemon2):
    def __init__(self,name="Sawk",type1="Fighting",type2="None",nature="None",level=100,happiness=255,hp=75,atk=135,defense=75,spatk=30,spdef=75,speed=100,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sturdy","Inner Focus","Contrary"]),item=random.choice(["Weakness Policy","Focus Sash","Expert Belt","Life Orb"])):
        if move =="None":
...
class Minun(Pokemon2):
    def __init__(self,name="Minun",type1="Electric",type2="None",nature="None",level=100,happiness=255,hp=60,atk=85,defense=75,spatk=50,spdef=40,speed=110,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Minus","Volt Absorb","Galvanize","Prankster"]),item=random.choice(["Focus Sash","Electric Gem"])):
        if move =="None":
...
class Castform(Pokemon2):
    def __init__(self,name="Castform",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=70,atk=70,defense=70,spatk=70,spdef=70,speed=70,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Forecast",item=random.choice(["Focus Sash","Heat Rock","Icy Rock","Smooth Rock","Damp Rock","Life Orb","Expert Belt","Petaya Berry","Lum Berry"])):
        if move =="None":
...
class Chimecho(Pokemon2):
    def __init__(self,name="Chimecho",type1="Psychic",type2="None",nature="None",level=100,happiness=255,hp=90,atk=50,defense=70,spatk=95,spdef=80,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Levitate",item=random.choice(["Focus Sash","Colbur Berry"])):
        if move =="None":
...
class Lilligant(Pokemon2):
    def __init__(self,name="Lilligant",type1="Grass",type2="None",nature="None",level=100,happiness=255,hp=70,atk=60,defense=75,spatk=110,spdef=75,speed=90,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Chlorophyll","Own Tempo"]),item=random.choice(["Focus Sash","Petaya Berry","Miracle Seed","Big Root"])):
        if move =="None":
...
class Alomomola(Pokemon2):
    def __init__(self,name="Alomomola",type1="Water",type2="None",nature="None",level=100,happiness=255,hp=165,atk=75,defense=80,spatk=40,spdef=45,speed=65,hpev=166,atkev=0,defev=252,spatkev=0,spdefev=92,speedev=0,maxiv="No",move="None", ability=random.choice(["Hydration","Regenerator"]),item=random.choice(["Leftovers","Heavy-Duty Boots","Rocky Helmet","Apicot Berry"])):
        if move =="None":
            avmoves=["Hydro Pump","Aqua Jet","Ice Beam","Surf","Play Rough","Protect","Chilling Water","Toxic","Scald","Knock Off","Wish","Mirror Coat","Calm Mind"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)             
...
class HRotom(Pokemon2):
    def __init__(self,name="Heat Rotom",type1="Electric",type2="Fire",nature="None",level=100,happiness=255,hp=50,atk=65,defense=107,spatk=105,spdef=107,speed=86,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Levitate"]),item=random.choice(["Leftovers","Flame Orb"])):
        if move =="None":
...
class Kecleon(Pokemon2):
    def __init__(self,name="Kecleon",type1="Normal",type2="Ghost",nature="None",level=100,happiness=255,hp=85,atk=110,defense=90,spatk=60,spdef=120,speed=40,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Color Change","Protean","Adaptability"]),item=random.choice(["Leftovers","Ganlon Berry"])):
        if move =="None":
...
class Stunfisk(Pokemon2):
    def __init__(self,name="Stunfisk",type1="Ground",type2="Electric",nature="None",level=100,happiness=255,hp=109,atk=66,defense=84,spatk=81,spdef=99,speed=32,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Static","Water Absorb","Sand Veil","Sand Stream"]),item=random.choice(["Leftovers","Rocky Helmet","Passho Berry","Petaya Berry"])):
        if move =="None":
...
class Morpeko(Pokemon2):
    def __init__(self,name="Full Belly Morpeko",type1="Electric",type2="Dark",nature="None",level=100,happiness=255,hp=55,atk=110,defense=58,spatk=70,spdef=58,speed=97,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Hunger Switch"]),item=random.choice(["Leftovers"])):
        if move =="None":
