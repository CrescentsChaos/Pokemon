...
class Alakazam(Pokemon2):
    ...
    def __init__(self,name="Alakazam",type1="Psychic",type2="None",nature="None",level=100,happiness=255,hp=55,atk=50,defense=45,spatk=135,spdef=95,speed=120,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Magic Guard","Inner Focus","Synchronize"]),item=random.choice(["Focus Sash","Choice Specs","Life Orb","Leftovers","Alakazite","Twisted Spoon","Colbur Berry"]),weight=105.82,sprite="sprites/Alakazam.png"):
        color=214
        if move =="None":
            avmoves=["Hidden Power","Recover","Dazzling Gleam","Shadow Ball","Nasty Plot","Dark Pulse","Focus Blast","Expanding Force","Trick","Signal Beam","Grass Knot","Calm Mind","Psyshock","Thunder Wave","Energy Ball"]
...
class Garbodor(Pokemon2):
    def __init__(self,name="Garbodor",type1="Poison",type2="None",nature="None",level=100,happiness=255,hp=80,atk=105,defense=92,spatk=60,spdef=92,speed=75,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Aftermath","Stench","Unburden","Weak Armor"]),item=random.choice(["Black Sludge","Shuca Berry","Payapa Berry","Salac Berry","Expert Belt"]),weight=236.56,gsprite="sprites/Gigantamax Garbodor.png"):
        color=199
        if move =="None":
...
class Lugia(Pokemon2):
    "Lugia"
    def __init__(self,name="Lugia",type1="Psychic",type2="Flying",nature="None",level=100,happiness=255,hp=106,atk=90,defense=130,spatk=90,spdef=154,speed=110,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Multiscale","Pressure"]),item=random.choice(["Choice Specs","Heavy-Duty Boots"]),weight=476.20,sprite="sprites/Lugia.png"):
        color=231
        if move =="None":
...
class Arbok(Pokemon2):
    "Arbok"
    def __init__(self,name="Arbok",type1="Poison",type2="Dark",nature="None",level=100,happiness=255,hp=75,atk=105,defense=75,spatk=65,spdef=80,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Intimidate","Strong Jaw","Shed Skin","Unnerve"]),item=random.choice(["Black Sludge","Shuca Berry","Choice Band"]),weight=143.3):
        color=199
        if move =="None":
...
class Whiscash(Pokemon2):
    ...
    def __init__(self,name="Whiscash",type1="Water",type2="Ground",nature="None",level=100,happiness=255,hp=115,atk=85,defense=73,spatk=80,spdef=71,speed=60,hpev=0,atkev=252,defev=252,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Oblivious","Anticipation","Adaptability"]),item=random.choice(["Leftovers","Rindo Berry","Zoom Lens"]),weight=52.03,sprite="sprites/Whiscash.png"):
        color=21
        if move =="None":
            avmoves=["Protect","Ancient Power","Ice Beam","Surf","Power Gem","Hydro Pump","Stone Edge","Earthquake","Rest","Magnitude","Future Sight","Fissure","Dragon Dance","Discharge","Waterfall","Blizzard","Rain Dance","Icy Wind","Muddy Water","Whirlpool","Bounce","Liquidation"]
            moves=moveset(type1,type2,avmoves,name=name)
        else:
            moves=move
        if "Rest" in moves:
...
class Torterra(Pokemon2):
    "Torterra"
    def __init__(self,name="Torterra",type1="Grass",type2="Ground",nature="None",level=100,happiness=255,hp=95,atk=109,defense=105,spatk=75,spdef=85,speed=56,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Overgrow","Rock Head","Shell Armor"]),item=random.choice(["Choice Band","Leftovers","Yache Berry","Bright Powder"]),weight=683.43,sprite="sprites/Torterra.png"):
        color=10
        if move =="None":
...
class Heatran(Pokemon2):
    "Heatran"
    def __init__(self,name="Heatran",type1="Fire",type2="Steel",nature="None",level=100,happiness=255,hp=91,atk=90,defense=106,spatk=130,spdef=106,speed=77,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Flash Fire"]),item=random.choice(["Leftovers","Air Balloon","Passho Berry","Shuca Berry","Focus Sash","Quick Claw","Bught Powder"]),weight=947.99,sprite="sprites/Heatran.png"):
        color=196
        if move =="None":
...
class Darkrai(Pokemon2):
    "Darkrai"
    def __init__(self,name="Darkrai",type1="Dark",type2="None",nature="None",level=100,happiness=255,hp=70,atk=90,defense=90,spatk=135,spdef=90,speed=125,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Bad Dreams"]),item=random.choice(["Leftovers","Salac Berry","Life Orb"]),weight=111.33,sprite="sprites/Darkrai.png"):
        color=196
        if move =="None":
...
class Basculegion (Pokemon2):
    "Basculegion"
    def __init__(self,name="Basculegion",type1="Water",type2="Ghost",nature="None",level=100,happiness=255,hp=120,atk=112,defense=65,spatk=80,spdef=75,speed=78,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Adaptability","Swift Swim","Mold Breaker","Rattled"]),item=random.choice(["Leftovers","Salac Berry"]),weight=242.5,sprite="sprites/Basculegion.png"):
        color=10
        if move =="None":
...
class Reshiram(Pokemon2):
    "Reshiram"
    def __init__(self,name="Reshiram",type1="Dragon",type2="Fire",nature="None",level=100,happiness=255,hp=100,atk=120,defense=100,spatk=150,spdef=120,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Turboblaze",item="Leftovers",weight=727.53,sprite="sprites/Reshiram.png"):
        color=196
        if move =="None":
...
class Xerneas(Pokemon2):
    "Xerneas"
    def __init__(self,name="Xerneas",type1="Fairy",type2="None",nature="None",level=100,happiness=255,hp=126,atk=131,defense=95,spatk=131,spdef=98,speed=99,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Fairy Aura",item="Power Herb",weight=473.99,sprite="sprites/Xerneas.png"):
        color=21
        if move =="None":
...
class Diancie(Pokemon2):
    "Diancie"
    def __init__(self,name="Diancie",type1="Rock",type2="Fairy",nature="None",level=100,happiness=255,hp=50,atk=100,defense=150,spatk=100,spdef=150,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability="Clear Body",item=random.choice(["Leftovers","Diancite"]),weight=19.4,sprite="sprites/Diancie.png"):
        color=199
        if move =="None":
...
class UHoopa(Pokemon2):
    "Hoopa Unbound"
    def __init__(self,name="Hoopa Unbound",type1="Psychic",type2="Dark",nature="None",level=100,happiness=255,hp=80,atk=160,defense=60,spatk=170,spdef=130,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Magician",item=random.choice(["Leftovers","Salac Berry"]),weight=1080.27,sprite="sprites/Unbound Hoopa.png"):
        color=199
        if move =="None":
...
class Toucannon(Pokemon2):
    "Toucannon"
    def __init__(self,name="Toucannon",type1="Normal",type2="Flying",nature="None",level=100,happiness=255,hp=90,atk=120,defense=75,spatk=75,spdef=75,speed=60,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Sheer Force","Skill Link"]),item=random.choice(["Leftovers","Focus Sash","Salac Berry"]),weight=56.32):
        if move =="None":
...
class Pheromosa(Pokemon2):
    "Pheromosa"
    def __init__(self,name="Pheromosa",type1="Rock",type2="Poison",nature="None",level=100,happiness=255,hp=71,atk=137,defense=37,spatk=137,spdef=37,speed=151,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Beast Boost"]),item="Leftovers",weight=55.12,sprite="sprites/Pheromosa.png"):
        color=3
        if move =="None":
...
class Orbeetle(Pokemon2):
    "Orbeetle"
    def __init__(self,name="Orbeetle",type1="Bug",type2="Psychic",nature="None",level=100,happiness=255,hp=60,atk=45,defense=110,spatk=80,spdef=120,speed=90,hpev=0,atkev=0,defev=4,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Swarm","Frisk"]),item="Expert Belt",weight=89.9,gsprite="sprites/Gigantamax Orbeetle.png"):
        color=196
        if move =="None":
...
class Sandaconda(Pokemon2):
    "Sandaconda"
    def __init__(self,name="Sandaconda",type1="Ground",type2="None",nature="None",level=100,happiness=255,hp=72,atk=107,defense=125,spatk=65,spdef=70,speed=71,hpev=252,atkev=252,defev=4,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Sand Spit","Sand Veil","Shed Skin"]),item=random.choice(["Leftovers","Rocky Helmet"]),weight=144.4,gsprite="sprites/Gigantamax Sandaconda.png"):
        color=3
        if move =="None":
...
class Toxtricity(Pokemon2):
    "Toxtricity"
    def __init__(self,name="Toxtricity",type1="Electric",type2="Poison",nature=random.choice(naturelist),level=100,happiness=255,hp=75,atk=98,defense=70,spatk=114,spdef=70,speed=75,hpev=0,atkev=0,defev=4,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Punk Rock","Technician"]),item=random.choice(["Throat Spray","Life Orb","Choice Specs","Air Balloon"]),weight=88.2,gsprite="sprites/Gigantamax Toxtricity.png"):
        color=3
        if move =="None":
...
class Alcremie(Pokemon2):
    "Alcremie"
    def __init__(self,name="Alcremie",type1="Fairy",type2="None",nature="None",level=100,happiness=255,hp=65,atk=60,defense=75,spatk=110,spdef=121,speed=64,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Sweet Veil",item="Leftovers",weight=1.1,gsprite="sprites/Gigantamax Alcremie.png"):
        color=199
        if move =="None":
...
class Eternatus(Pokemon2):
    "Eternatus"
    def __init__(self,name="Eternatus",type1="Poison",type2="Dragon",nature="None",level=100,happiness=255,hp=140,atk=85,defense=95,spatk=145,spdef=95,speed=130,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability="Pressure",item=random.choice(["Power Herb","Lum Berry"]),weight=2094.4,sprite="sprites/Eternatus.png"):
        color=18
        if move =="None":
...
class Zarude(Pokemon2):
    "Zarude"
    def __init__(self,name="Zarude",type1="Dark",type2="Grass",nature="None",level=100,happiness=255,hp=105,atk=120,defense=105,spatk=70,spdef=95,speed=105,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability="Leaf Guard",item=random.choice(["Heavy Duty Boots","Leftovers","Choice Scarf"]),weight=154.3,sprite="sprites/Zarude.png"):
        color=236
        if move =="None":
...
class Raticate(Pokemon2):
    def __init__(self,name="Raticate",type1="Normal",type2="None",nature="None",level=100,happiness=255,hp=60,atk=91,defense=70,spatk=45,spdef=70,speed=107,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Guts","Hustle","Adaptability","Strong Jaw"]),item=random.choice(["Life Orb","Silk Scarf","Focus Sash"]),weight=40.79):
        color=166
        if move =="None":
...
class AMarowak(Pokemon2):
    def __init__(self,name="Alolan Marowak",type1="Fire",type2="Ghost",nature="None",level=100,happiness=255,hp=80,atk=80,defense=110,spatk=30,spdef=80,speed=45,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Rock Head","Bone Zone","Skill Link"]),item="Leftovers",weight=74.96,sprite="sprites/Alolan Marowak.png"):
        color=246
        if move =="None":
...
class Bellossom(Pokemon2):
    def __init__(self,name="Bellossom",type1="Grass",type2="Fairy",nature="None",level=100,happiness=255,hp=75,atk=80,defense=85,spatk=90,spdef=100,speed=100,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Chlorophyll","Triage"]),item=random.choice(["Life Orb"]),weight=12.79):
        ...
        if move =="None":
            ...
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item,weight=weight,color=color)                                        #Sudowoodo
...
class Jumpluff(Pokemon2):
    def __init__(self,name="Jumpluff",type1="Grass",type2="Flying",nature="None",level=100,happiness=255,hp=75,atk=85,defense=70,spatk=35,spdef=95,speed=110,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Chlorophyll","Fluffy","Aerilate"]),item=random.choice(["Life Orb","Yache Berry","Focus Sash","Leftovers"]),weight=6.61):
        color=25
        if move =="None":
...
class Donphan(Pokemon2):
    def __init__(self,name="Donphan",type1="Ground",type2="None",nature="None",level=100,happiness=255,hp=90,atk=120,defense=120,spatk=60,spdef=70,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move="None", ability=random.choice(["Sturdy","Technician","Battle Armor"]),item=random.choice(["Leftovers","Lum Berry","Quick Claw","Bright Powder","Focus Band","Razor Claw"]),weight=264.55):
        ...
        if move =="None":
            ...
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item,weight=weight,color=color)                                        #Porygon2
...
class Oricorio(Pokemon2):
    def __init__(self,name="Oricorio",type1=random.choice(["Fire","Electric","Psychic","Ghost"]),type2="Flying",nature="None",level=100,happiness=255,hp=75,atk=70,defense=70,spatk=98,spdef=70,speed=93,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move="None", ability=random.choice(["Dancer"]),item=random.choice(["Focus Sash"]),weight=7.5,sprite="sprites/Oricorio.png"):
        ...
        if type1=="Ghost":
            name="Sensu Oricorio"
            sprite="sprites/Sensu Oricorio.png"
            color=21
        if type1=="Psychic":
            name="Pa`u Oricorio"
            color=199
