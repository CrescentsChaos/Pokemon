...
#NATURE BOOST
    def natureboost(self):
        ...
        if self.nature in ["Adamant","Brave","Lonely","Naughty"]:
            self.maxatk+=round(self.atk*0.1)
        if self.nature in ["Mild","Modest","Quite","Rash"]:
            self.maxspatk+=round(self.spatk*0.1)
...
def movelist(self):
    ...
    if self.dmax is False:
        x=None
        if self.item!=None and "m Z" in self.item:
            x=4
        if self.item==None or "m Z" not in self.item:
            x=len(self.moves)
        for i in range(x):
            num+=1
...
class Venusaur(Pokemon2):
    "Venusaur"
    def __init__(self,name="Venusaur",type1="Grass",type2="Poison",nature=None,level=100,happiness=255,hp=80,atk=82,defense=83,spatk=100,spdef=100,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Overgrow","Chlorophyll"]),item=random.choice(["Black Sludge","Life Orb","Grass Gem","Poison Gem","Venusaurite"]),weight=220.46):
        if move is None:
            ch=1
            if ch==1:
...
class Dodrio(Pokemon2):
    ...
    def __init__(self,name="Dodrio",type1="Normal",type2="Flying",nature=None,level=100,happiness=255,hp=60,atk=110,defense=70,spatk=60,spdef=60,speed=110,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Rock Head","Early Bird","Tangled Feet"]),item=random.choice(["Choice Scarf","Heavy-Duty Boots"])):
        if move is None:
            avmoves=["Close Combat","Brave Bird","Roost","Sky Attack","High Jump Kick","U-Turn","Double-Ed"]
            moves=moveset(avmoves)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)
...
class Lapras(Pokemon2):
    ...
    def __init__(self,name="Lapras",type1="Water",type2="Ice",nature=None,level=100,happiness=255,hp=130,atk=85,defense=80,spatk=85,spdef=95,speed=60,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Water Absorb","Liquid Voice"]),item=random.choice(["Choice Specs","Heavy-Duty Boots"]),dmax=False):
        if move is None:
            avmoves=["Hidden Power","Ice Beam","Hydro Pump","Thunderbolt","Surf","Snowscape","Rain Dance","Aurora Veil","Boomburst","Sparkling Aria"]
            moves=moveset(avmoves)
        else:
            moves=move
...
class Dragonite(Pokemon2):
    def __init__(self,name="Dragonite",type1="Dragon",type2="Flying",nature=None,level=100,happiness=255,hp=91,atk=134,defense=95,spatk=100,spdef=100,speed=80,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Multiscale","Inner Focus"]),item=random.choice(["Weakness Policy","Leftovers","Choice Band","Heavy-Duty Boots","Yache Berry"])):
        if move is None:
            ch=1
            if ch==1:
...
class Azumarill(Pokemon2):
    ...
    def __init__(self,name="Azumarill",type1="Water",type2="Fairy",nature=None,level=100,happiness=255,hp=100,atk=50,defense=80,spatk=60,spdef=80,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Huge Power","Thick Fat"]),item=random.choice(["Choice Band","Sitrus Berry","Assault Vest"])):
        if move is None:
            avmoves=["Protect","Ice Beam","Play Rough","Liquidation","Belly Drum","Superpower","Ice Spinner","Chilling Water","Ice Punch"]
...
class Aggron(Pokemon2):
    "Aggron"
    def __init__(self,name="Aggron",type1="Steel",type2="Rock",nature=None,level=100,happiness=255,hp=70,atk=110,defense=180,spatk=60,spdef=60,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Rock Head","Sturdy","Heavy Metal"]),item=random.choice(["Choice Band","Leftovers","Aggronite"])):
        if move is None:
...
class Registeel(Pokemon2):
    ...
    def __init__(self,name="Registeel",type1="Steel",type2=None,nature=None,level=100,happiness=255,hp=80,atk=75,defense=150,spatk=75,spdef=150,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Clear Body","Filter","Steely Spirit"]),item="Leftovers"):
        if move is None:
            avmoves=["Protect","Iron Head","Flash Cannon","Zap Cannon","Earthquake","Hyper Beam","Curse","Explosion","Double Iron Bash"]
            moves=moveset(avmoves)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)   
...
class Jynx(Pokemon2):
    ...
    def __init__(self,name="Jynx",type1="Ice",type2="Psychic",nature=None,level=100,happiness=255,hp=65,atk=50,defense=50,spatk=115,spdef=95,speed=100,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move=None, ability="Dry Skin",item="Leftovers"):
        if move is None:
            avmoves=["Protect","Hidden Power","Ice Beam","Psychic","Blizzard","Dark Pulse","Hail","Shadow Ball","Trick Room","Light Screen","Expanding Force","Draining Kiss","Triple Axel","Freezing Glare","Psycho Boost","Psystrike"]
            moves=moveset(avmoves)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)           
...
class Honchkrow(Pokemon2):
    ...
    def __init__(self,name="Honchkrow",type1="Dark",type2="Flying",nature=None,level=100,happiness=255,hp=100,atk=125,defense=60,spatk=105,spdef=60,speed=96,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Super Luck","Moxie","Insomnia"]),item=random.choice(["Scope Lens","Heavy-Duty Boots"])):
        if move is None:
            avmoves=["Protect","Night Slash","Shadow Ball","Drill Peck","Roost","Dark Pulse","Tailwind","Heat Wave","Sucker Punch"]
            moves=moveset(avmoves)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)          
...
class Gallade(Pokemon2):
    "Gallade"
    def __init__(self,name="Gallade",type1="Psychic",type2="Fighting",nature=None,level=100,happiness=255,hp=68,atk=125,defense=65,spatk=65,spdef=115,speed=80,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=4,speedev=252,maxiv="No",move=None, ability=random.choice(["Steadfast","Sharpness"]),item=random.choice(["Choice Band","Assault Vest","Life Orb","Galladite"])):
        if move is None:
...
class Probopass(Pokemon2):
    ...
    def __init__(self,name="Probopass",type1="Rock",type2="Steel",nature=None,level=100,happiness=255,hp=65,atk=45,defense=145,spatk=80,spdef=150,speed=40,hpev=252,atkev=0,defev=0,spatkev=0,spdefev=252,speedev=0,maxiv="No",move=None, ability=random.choice(["Sturdy","Levitate","Magnet Pull"]),item=random.choice(["Leftovers","Air Balloon"])):
        if move is None:
            avmoves=["Protect","Iron Defense","Thunder Wave","Heavy Slam","Sandstorm","Zap Cannon","Power Gem","Rest","Rock Slide","Light Screen","Reflect","Steel Beam","Flash Cannon","Hidden Power","Taunt","Stealth Rock"]
            moves=moveset(avmoves)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                       
...
class GDarmanitan(Pokemon2):
    ...
    def __init__(self,name="Galarian Darmanitan",type1="Ice",type2=None,nature=None,level=100,happiness=255,hp=105,atk=140,defense=55,spatk=30,spdef=55,speed=95,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Gorilla Tactics","Zen Mode"]),item="Choice Scarf"):
        if move is None:
            avmoves=["Superpower","Earthquake","Stone Edge","Crunch","Icicle Crash","U-Turn","Ice Hammer"]
            moves=moveset(avmoves)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                        
...
class TLandorus(Pokemon2):
    "Therian Landorus"
    def __init__(self,name="Therian Landorus",type1="Ground",type2="Flying",nature=None,level=100,happiness=255,hp=89,atk=145,defense=90,spatk=105,spdef=80,speed=91,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability="Intimidate",item=random.choice(["Leftovers","Choice Scarf","Focus Sash","Earth Plate"])):
        if move is None:
...
class Aurorus(Pokemon2):
    ...
    def __init__(self,name="Aurorus",type1="Rock",type2="Ice",nature=None,level=100,happiness=255,hp=123,atk=77,defense=72,spatk=99,spdef=92,speed=58,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Refrigerate","Snow Warning"]),item="Leftovers", shield=True,sword=False):
        if move is None:
            avmoves=["Giga Impact","Blizzard","Ice Beam","Stone Edge","Freeze-Dry","Light Screen","Meteor Beam","Diamond Storm","Boomburst"]
            moves=moveset(avmoves)
        else:
            moves=move
        self.shield=shield
...
class HAvalugg(Pokemon2):
    ...
    def __init__(self,name="Hisuian Avalugg",type1="Ice",type2="Rock",nature=None,level=100,happiness=255,hp=95,atk=127,defense=184,spatk=34,spdef=36,speed=38,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability="Sturdy",item="Leftovers", shield=True,sword=False):
        if move is None:
            avmoves=["Mountain Gale","Ice Shard","Icicle Crash","Stone Edge","Earthquake","Iron Defense","Accelerock"]
            moves=moveset(avmoves)
        else:
            moves=move
        self.shield=shield
...
class Avalugg(Pokemon2):
    ...
    def __init__(self,name="Avalugg",type1="Ice",type2=None,nature=None,level=100,happiness=255,hp=95,atk=117,defense=184,spatk=44,spdef=46,speed=28,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Fliter","Sturdy","Ice Body"]),item=random.choice(["Leftovers","Heavy-Duty Boots"])):
        if move is None:
            avmoves=["Mountain Gale","Ice Shard","Icicle Crash","Earthquake","Iron Defense","Recover","Skull Bash","Body Press","Rapid Spin"]
            moves=moveset(avmoves)
        else:
            moves=move
...
class CZygarde(Pokemon2):
    "Zygarde"
    def __init__(self,name="Zygarde",type1="Dragon",type2="Ground",nature=None,level=100,happiness=255,hp=108,atk=100,defense=121,spatk=81,spdef=95,speed=95,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Power Constrict","Aura Break"]),item="Leftovers"):
        if move is None:
...
class UHoopa(Pokemon2):
    ...
    def __init__(self,name="Hoopa Unbound",type1="Psychic",type2="Dark",nature=None,level=100,happiness=255,hp=80,atk=160,defense=60,spatk=170,spdef=130,speed=80,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move=None, ability="Magician",item="Leftovers"):
        if move is None:
            avmoves=["Protect","Hyperspace Fury","Psychic","Dark Pulse","Shadow Ball","Hyperspace Hole","Dark Hole"]
            moves=moveset(avmoves)
        else:
            moves=move
...
class Silvally(Pokemon2):
    ...
    def __init__(self,name="Silvally",type1=random.choice(["Rock","Fire","Water","Grass","Electric","Ground","Flying","Fighting","Fairy","Dragon","Steel","Poison","Dark","Ghost","Normal","Bug","Ice"]),type2=None,nature=None,level=100,happiness=255,hp=100,atk=100,defense=100,spatk=100,spdef=100,speed=100,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["RKS System"]),item="Elemental Disks"):
        if move is None:
            avmoves=["Protect","Multi-Attack","Hyper Beam","Double-Edge","Crush Claw","Parting Shot","Explosion","Thunder Wave"]
            moves=moveset(avmoves)
        else:
            moves=move
        name=name+"-"+type1
...
class Lunala(Pokemon2):
    ...
    def __init__(self,name="Lunala",type1="Psychic",type2="Ghost",nature=None,level=100,happiness=255,hp=137,atk=113,defense=89,spatk=157,spdef=107,speed=97,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Shadow Shield"]),item="Leftovers"):
        if move is None:
            avmoves=["Moongeist Beam","Phamtom Force","Moonblast","Night Daze","Moonlight","Shadow Ball","Psychic","Meteor Beam","Esper Wing"]
            moves=moveset(avmoves)
        else:
            moves=move
...
class Naganadel (Pokemon2):
    "Naganadel"
    def __init__(self,name="Naganadel",type1="Poison",type2="Dragon",nature=None,level=100,happiness=255,hp=73,atk=73,defense=73,spatk=127,spdef=73,speed=121,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Beast Boost"]),item=random.choice(["Leftovers","Life Orb"])):
        if move is None:
...
class GMoltres(Pokemon2):
    "Moltres"
    def __init__(self,name="Galarian Moltres",type1="Dark",type2="Flying",nature=None,level=100,happiness=255,hp=90,atk=85,defense=90,spatk=100,spdef=125,speed=90,hpev=0,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=252,maxiv="No",move=None, ability="Berserk",item=random.choice(["Leftovers","Weakness Policy","Life Orb"])):
        if move is None:
...
class Cinderace(Pokemon2):
    ...
    def __init__(self,name="Cinderace",type1="Fire",type2=None,nature=None,level=100,happiness=255,hp=80,atk=116,defense=75,spatk=65,spdef=75,speed=119,hpev=80,atkev=164,defev=0,spatkev=0,spdefev=48,speedev=216,maxiv="No",move=None, ability=random.choice(["Libero","Blaze"]),item=random.choice(["Heavy-Duty Boots","Charcoal","Life Orb"])):
        if move is None:
            avmoves=["Pyro Ball","Court Change","U-Turn","Sucker Punch","Gunk Shot","Zen Headbutt","High Jump Kick","Scorching Sands"]
            moves=moveset(avmoves)
        else:
            moves=move
...
class Corviknight(Pokemon2):
    "Corviknight"
    def __init__(self,name="Corviknight",type1="Flying",type2="Steel",nature=None,level=100,happiness=255,hp=98,atk=87,defense=105,spatk=53,spdef=85,speed=67,hpev=252,atkev=252,defev=4,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Pressure","Mirror Armor"]),item=random.choice(["Leftovers","Rocky Helmet"])):
        if move is None:
...
class Dragapult(Pokemon2):
    "Dragapult"
    def __init__(self,name="Dragapult",type1="Dragon",type2="Ghost",nature=None,level=100,happiness=255,hp=88,atk=120,defense=75,spatk=100,spdef=75,speed=142,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability="Infiltrator",item=random.choice(["Choice Band","Life Orb","Choice Specs"])):
        if move is None:
...
class ICalyrex(Pokemon2):
    "Calyrex"
    def __init__(self,name="Ice Rider Calyrex",type1="Psychic",type2="Ice",nature=None,level=100,happiness=255,hp=100,atk=165,defense=150,spatk=85,spdef=130,speed=50,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability="As One",item=random.choice(["Leftovers","Heavy-Duty Boots","Choice Band","Life Orb","Weakness Policy"])):
        if move is None:
            avmoves=["Swords Dance","High Horsepower","Close Combat","Leech Seed","Trick","Psyshock"]
...
class Cetitan(Pokemon2):
    ...
    def __init__(self,name="Cetitan",type1="Ice",type2=None,nature=None,level=100,happiness=255,hp=170,atk=113,defense=65,spatk=45,spdef=55,speed=73,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Thick Fat","Slush Rush"]),item=random.choice(["Leftovers","Sitrus Berry","Heavy-Duty Boots"])):
        if move is None:
            avmoves=["Belly Drum","Icicle Crash","Protect","Stone Edge","Ice Spinner","Ice Shard","Yawn","Earthquake","Play Rough","Heavy Slam"]
            moves=moveset(avmoves)
        else:
            moves=move
...
class Wigglytuff(Pokemon2):
    def __init__(self,name="Wigglytuff",type1="Normal",type2="Fairy",nature=None,level=100,happiness=255,hp=140,atk=70,defense=45,spatk=85,spdef=50,speed=45,hpev=252,atkev=0,defev=0,spatkev=252,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Competitive","Sheer Force","Frisk"]),item=random.choice(["Leftovers","Life Orb"])):
        if move is None:
            avmoves=["Body Slam","Moonblast","Rest","Play Rough","Gyro Ball","Expanding Force","Misty Explosion","Flamethrower","Thunderbolt","Ice Beam"]
            moves=moveset(avmoves)
        else:
            moves=move
...
class Marowak(Pokemon2):
    def __init__(self,name="Marowak",type1="Ground",type2=None,nature=None,level=100,happiness=255,hp=80,atk=80,defense=110,spatk=30,spdef=80,speed=45,hpev=0,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=252,maxiv="No",move=None, ability=random.choice(["Rock Head","Bone Zone","Battle Armor"]),item="Leftovers"):
        if move is None:
            avmoves=["Bone Rush","Bonemerang","Earthquake","Stomping Tantrum","Bulldoze","Rock Slide","Swords Dance","Stealth Rock","Head Smash"]
            moves=moveset(avmoves)
        else:
            moves=move
        super().__init__(name,type1,type2,nature,level,happiness,hp,atk,defense,spatk,spdef,speed,maxiv=maxiv,moves=moves,hpev=hpev,atkev=atkev,defev=defev,spatkev=spatkev,spdefev=spdefev,speedev=speedev, ability=ability,item=item)                        #Marowak
...
class Amoongus(Pokemon2):
    def __init__(self,name="Amoongus",type1="Grass",type2="Poison",nature=None,level=100,happiness=255,hp=114,atk=85,defense=70,spatk=85,spdef=80,speed=80,hpev=252,atkev=0,defev=172,spatkev=0,spdefev=84,speedev=0,maxiv="No",move=None, ability="Regenerator",item=random.choice(["Black Sludge","Rocky Helmet"])):
        if move is None:
...
class Crustle(Pokemon2):
    def __init__(self,name="Crustle",type1="Bug",type2="Rock",nature=None,level=100,happiness=255,hp=70,atk=95,defense=125,spatk=65,spdef=75,speed=55,hpev=252,atkev=252,defev=0,spatkev=0,spdefev=0,speedev=0,maxiv="No",move=None, ability=random.choice(["Sturdy","Shell Armor","Weak Armor"]),item=random.choice(["Leftovers","White Herb"])):
        if move is None:
