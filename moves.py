...
def cottonguard(self):
    print(f" 🧶 {self.name} used Cotton Guard.")   
    defchange(self,1.5)
    print(f" Defense x{self.defb}")     
def leechseed(self,other):
    print(f" 🌱 {self.name} used Leech Seed.")
    if (self.type1=="Grass" or self.type2=="Grass") or other.seeded is True:
        print(" It failed!")
    if other.type1!="Grass" and other.type2!="Grass" and other.ability!="Magic Bounce" and other.seeded is False:
        other.seeded=True
        print(f" 🌱{other.name} was seeded.")
    elif self.type1!="Grass" and self.type2!="Grass"  and other.ability=="Magic Bounce" and self.seeded is False:
        self.seeded=True
...
def defendorder(self):
    print(f" 🐝🛡️ {self.name} used Defend Order.")
    spdefchange(self,0.5)     
    defchange(self,0.5)   
    print(f" Defense x{self.defb}")    
    print(f" Special Defense x{self.spdefb}")
...
def skullbash(self,other):       
    print(f" ⛑️ {self.name} used Skull Bash.")
...
def meteorbeam(self,other):       
    print(f" ☄️ {self.name} used Meteor Beam.")
    if self.item=="Power Herb" or self.precharge is True:
        if self.item=="Power Herb":
            self.item=None  
            spatkchange(self,0.5)
...
def mortalspin(self,other,tr1):
    print(f" 🥏 {self.name} used Mortal Spin.")
    self.atktype="Poison"
...
def rapidspin(self,other,tr1):
    print(f" 🥏 {self.name} used Rapid Spin.")
    self.atktype="Normal"
    al=1
    r=randroll()
    c=critch(self,other)
...
def stormshards(self,other):
    al=1
    r=randroll()
    print(f" 🪨☄️ {self.name} used "+colored(" Splintered Stromshards","yellow")+"!")   
    self.atktype="Rock"
    c=critch(self,other)
    ab=weakness(self,other,field)
    a=ab[0]
...
def gmaxreplenish(self,other):
    al=1
    r=randroll()
    print(f" 🔺🍐 {self.name} used G-Max Replenish!")
    self.atktype="Normal"
    c=critch(self,other)
    ab=weakness(self,other,field)
    a=ab[0]
...
def maxstrike(self,other):
    al=1
    r=randroll()
    print(f" 🔺✴️ {self.name} used Max Strike!")
    self.atktype="Normal"
    c=critch(self,other)
    ab=weakness(self,other,field)
    a=ab[0]
...
def bleakwindstorm(self,other):
    ...
    w=weathereff(self)
    r=randroll()
    print(f" 🌪️❄️ {self.name} used Bleakwind Storm.")
    self.atktype="Flying"
    c=critch(self,other)
    ab=weakness(self,other,field)
    a=ab[0]
...
def technoblast(self,other):
    ...
    if self.item=="Burn Drive":
        self.atktype="Fire"
        print(f" 🔥 {self.name}'s {self.item} made Techno Blast {self.atktype}!")
    if self.item=="Chill Drive":
        self.atktype="Ice"
        print(f" ❄️ {self.name}'s {self.item} made Techno Blast {self.atktype}!")
...
def chillingwater(self,other):
    ...
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Chilling Waters","blue")+"!")
    c=critch(self,other)
    ab=weakness(self,other,field)
    a=ab[0]
    b=ab[1]   
...
def torchsong(self,other):
    ...
    al=1
    r=randroll()
    print(f" 🔦 {self.name} used  "+colored("Torch Song","red")+"!")
    c=critch(self,other)
    ab=weakness(self,other,field)
    a=ab[0]
    b=ab[1]   
...
def collisioncourse(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Collision Course","red")+"!")
    c=critch(self,other)
    self.atktype="Fighting"
    ab=weakness(self,other,field)
    a=ab[0]
...
def auroraveil(self,other,tr1,turn):    
    print(f" {self.name} used  "+colored("Aurora Veil","magenta")+"!")
...
def icespinner(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Ice Spinner","cyan")+"!")
    c=critch(self,other)
    self.atktype="Ice"
    w=weathereff(self)
    ab=weakness(self,other,field)
...
def bitterblade(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used "+colored("Bitter Blade","red")+"!")
    c=critch(self,other)
    self.atktype="Fire"
    w=weathereff(self)
    if self.ability=="Sharpness":
...
def glaciallance(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Glacial Lance","cyan")+"!")
    c=critch(self,other)
    self.atktype="Ice"
    w=weathereff(self)
    ab=weakness(self,other,field)
...
def grassyglide(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Grassy Glide","green")+"!")
    c=critch(self,other)
    self.atktype="Grass"
    ab=weakness(self,other,field)
    a=ab[0]
...
def slash(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Slash","white")+"!")
    if self.ability=="Sharpness":
        al*=1.5
    c=critch(self,other,2)
    self.atktype="Normal"
...
def kowtowcleave(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Kowtow Cleave","red")+"!")
    c=critch(self,other,2)
    self.atktype="Dark"
    if self.ability=="Tough Claws":
        print(f" {self.name}'s {self.ability}!")
...
def ragefist(self,other):
    al=1
    r=randroll()
    print(f" 💢 {self.name} used Rage Fist!")
    c=critch(self,other)
    self.atktype="Ghost"
    ab=weakness(self,other,field)
    a=ab[0]
...
def ceaseless(self,other):
    al=1
    r=randroll()
    print(f" {self.name} used  "+colored("Ceaseless Edge","red")+"!")
    c=critch(self,other,16)
    self.atktype="Dark"
    if self.ability=="Sharpness":
        al*=1.5
...
def chillyreception (self,other,tr1,turn):
    print(f" {self.name} used Chilly Reception!")
...
def snowscape(self,other,tr1,turn):
    print(f" {self.name} used Snowscape.")
    if field.weather not in ["Desolate Land","Primordial Sea","Strong Wind","Snowstorm"]:
        print(f" {self.name} started a snowstorm.")
        field.weather="Snowstorm" 
        tr1.snowstormturn=turn
...
def terablast(self,other):
    if True:
        ...
        if self.teratype=="Fire":
            typ="🔥"
        print(f" {typ} {self.name} used Tera Blast!")
