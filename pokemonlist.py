...
watermon=[Amomola,Blastoise, MBlastoise,Golduck, Poliwrath,Tentacruel,Slowbro, MSlowbro,Dewgong, Cloyster,Kingler,Kingdra,Seaking,Starmie,Gyarados,MGyarados,Lapras, Vaporeon, Feraligatr, Lanturn, Azumarill,Politoed, Quagsire, Slowking,Corsola,Octillery, Mantine,Suicune, Swampert,MSwampert, Ludicolo,Pelipper,Sharpedo, MSharpedo,Wailord,Whiscash, Crawdaunt, Milotic,Huntail,Gorebyss,Relicanth,Kyogre, PKyogre,Empoleon,Floatzel, EGastrodon, WGastrodon, Lumineon,Palkia,OPalkia,Phione, Samurott,HSamurott,Simipour, Seismitoad, Basculegion,Carracosta,Swanna, Jellicent,Keldeo, Greninja, Clawitzer,Primarina,SWishiwashi, Araquanid,Tapufini,Inteleon,Drednaw,Barraskewda,Dracovish, Quaquaval,Wugtrio, Dondozo,Veluza,Palafin]
...
fightingmon=[Primeape, Poliwrath,Machamp,Hitmonlee, Hitmonchan,PTauros,GZapdos,Hitmontop,Hariyama,Medicham, MMedicham,Lucario,MLucario, Conkeldurr,Throh,Sawk,Mienshao,Pangoro,Hawlucha,Crabominable,Passimian, Marshadow,Grapplot, Sirfetchd, Zamazenta, DUrshifu, WUrshifu, Ironhands, Annihilape,Koraidon]
...
normalmon=[Eevee,Komala,Vigoroth,Pidgeot, MPidgeot, Raticate, ARaticate,Fearow, Wigglytuff, Persian,Dodrio,Chansey, Kangaskhan, MKangaskhan,Tauros,Ditto,Snorlax,Furret, Noctowl, Ursaring, Porygon2, Smeargle,Miltank,Blissey, Linoone, Swellow, Slaking,Exploud, Delcatty,Spinda, Zangoose,Kecleon,Staraptor,Bibarel, Lopunny, MLopunny, Purugly, Lickilicky, PorygonZ, Regigigas, Arceus,Watchog, Stoutland, Unfezant,Audino,MAudino,HZoroark, Cinccino, Sawsbuck, Bouffalant, Braviary,Meloetta,Diggersby,Toucannon,Gumshoos,Bewear
