...
hoenn=["Littleroot Town","Petalburg City","Rustboro City","Dewford Town","Mauville City","Lavaridge Town","Fortree City","Mosdeep City","Sootopolis City","Evergrande City","Aqua Hideout","Magma Hideout","Terra Cave","Marine Cave","Mt. Pyre","Mt. Chimney"]
sinnoh=["Twinleaf Town","Oreburgh City","Eterna City","Hearthome City","Veilstone City","Pastoria City","Canalave City","Iron Island","Snowpoint City","Sunnyshore City","Mountain Stark","Spear Pillar","Mount Coronet"]
class Field:
